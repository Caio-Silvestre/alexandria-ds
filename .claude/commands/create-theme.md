...
Create a new Pharos theme using `defineTheme`.
...
```json
{
  "name": "@pharos-ds/theme-{themeName}",
  "version": "0.0.1",
  "private": false,
  "description": "{Description} theme for Pharos",
  "license": "MIT",
  "sideEffects": false,
  "main": "./src/index.ts",
  "types": "./src/index.ts",
  ...
  "files": ["dist", "src"],
  "scripts": {
    "build:theme": "pharos theme build src/index.ts -o dist/theme.css"
  },
  "peerDependencies": {
    "@pharos-ds/core": "*"
  },
...
```css
@scope ([data-pharos-theme="{themeName}"]) to ([data-pharos-theme]) {
...
- **Built**: `pharos theme build` pre-compiles to a CSS file
