      ...
      violations: [
        {
          ...
          nodes: [
            { html: '<input type="text" class="pharos-time-input">', target: ['.pharos-time-input'] },
          ],
        },
        {
          id: 'color-contrast',
          ...
          stories: ['Disabled'],
          nodes: [
            { html: '<span class="pharos-time-label">Hours</span>', target: ['.pharos-time-label'] },
          ],
        },
      ],
      storyDetails: [],
      ...
      violations: [
        {
          ...
          nodes: [
            { html: '<button class="pharos-button">', target: ['.pharos-button'] },
          ],
        },
      ],
      storyDetails: [],
...
bundleSection += `|---------|------------|------------|----------|\n`;
bundleSection += `| @pharos-ds/core | ${analysis.totalBundle?.esmSize || 'N/A'} | ${analysis.totalBundle?.cjsSize || 'N/A'} | ${analysis.totalBundle?.gzipSize || 'N/A'} |\n\n`;
