...
/**
 * Generates a JSON bundle of all @pharos-ds/core .d.ts files for the playground's
 * Monaco editor. Output: public/playground-types.json
 *
 * Structure: { "@pharos-ds/core": { "Button/index.d.ts": "...", ... } }
 *
...
const pharosTypes = collectDts(distDir);
const fileCount = Object.keys(pharosTypes).length;
...
console.log(`Generated playground-types.json: ${fileCount} Pharos type files, ${(json.length / 1024).toFixed(0)}KB`);
