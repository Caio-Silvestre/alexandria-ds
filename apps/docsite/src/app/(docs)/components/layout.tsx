...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'Components',
    description:
      'Browse every Pharos component with copy-ready examples for each variant, state, and pattern.',
    path: '/components',
  }),
  // Brand the per-component page titles (e.g. "Button · Pharos") so browser
