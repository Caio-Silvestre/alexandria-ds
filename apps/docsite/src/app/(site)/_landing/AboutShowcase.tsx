...
const styles = stylex.create({
  ...
  //
  // Rendered as a raw <span> in the JSX because Pharos has no
  ...
  // "→" arrow trail on the CTA link. Pharos's Link renders inline
...
const columns: AboutColumn[] = [
  ...
  },
  {
    ...
    description:
      'The quality bar is accelerating. Pharos pairs opinionated foundations with flexible patterns so your system keeps pace, no matter how the craft evolves.',
  ...
  return (
    <VStack gap={4} xstyle={styles.headingBlock}>
      <Heading level={2} type="display-2" color="primary">
        Pharos powers over 13,000 apps
      </Heading>
      <Text type="large" weight="normal" color="secondary">
        Pharos has grown inside Meta over the last eight years, shaped by the
