 ...
 *
 * Cards are real @pharos-ds/core components, so wrapping the set in <Theme> re-skins
...
import {ChatComposer, ChatSendButton} from '@pharos-ds/core/Chat';
...
const REWARD_MEMBER_AVATAR = demoImg('DATA-Ami-Pena');
