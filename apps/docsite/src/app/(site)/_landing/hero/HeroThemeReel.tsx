...
import {PharosLogo} from '../../../../components/logos';
...
const styles = stylex.create({
  ...
  // docsite (Pharos) --radius-page = 32px. We can't read --radius-page here
...
/** Themed, recolorable Pharos wordmark for the centered content column. */
