...
/**
 * Pharos community page — channels + contribution paths + live
 * contributors.
 *
...
import {getKey} from '@pharos-ds/core/utils';
import {
  PharosLogo,
  GitHubLogo,
  DiscordLogo,
...
const styles = stylex.create({
  ...
  blockCard: {
    height: '100%',
    overflow: 'hidden',
    backgroundColor: 'var(--pharos-marketing-feature-card-bg)',
  },
  blockCardStack: {
    height: '100%',
  },
...
// =============================================================================
// WallCard — Pharos wordmark + scattered contributor faces
// =============================================================================
    ...
    <Card padding={0} xstyle={styles.wallCard}>
      ...
      <div {...stylex.props(styles.wallCardCenter)}>
        ...
        <Text type="body" color="primary" xstyle={styles.wallDescription}>
          A growing community of designers and engineers ship Pharos together.
          <br />
...
const RFC_STEPS: ReadonlyArray<StepperStep> = [
  ...
  },
  {
    ...
    description:
      'New components ship in @pharos-ds/lab first, where the team and real users put them through their paces.',
  },
  {
    number: '04',
    title: 'Make it official',
    description:
      'Once battle-tested and refined, the work graduates from @pharos-ds/lab into @pharos-ds/core for everyone to use.',
  },
];
...
const START_HERE: ReadonlyArray<StartHerePath> = [
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Docs page preview showing the Pharos documentation site',
    },
  },
  {
...
const RESOURCE_CATEGORIES: ReadonlyArray<ResourceCategory> = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'How to use AI assistants effectively within Pharos conventions.',
      ...
      },
      {
        ...
        description:
          'How components in Pharos are named, shaped, and composed.',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: 'MIT License',
        description:
          'Pharos is open source under the MIT License. Free to use.',
...
// the public foundation Pharos is built on — as a stand-in for the
// Pharos contributor set. Falls back to Unsplash placeholders if the
// request fails.
...
export const metadata: Metadata = pageMetadata({
  title: 'Community',
  description:
    'Join the Pharos community: contribute on GitHub, follow updates, and meet the people building the design system.',
  path: '/community',
});
            ...
            <div {...stylex.props(styles.contribProcess)}>
              <VStack gap={1}>
                ...
                <Text type="body" color="secondary">
                  Contributing to Pharos means contributing to the system, not
