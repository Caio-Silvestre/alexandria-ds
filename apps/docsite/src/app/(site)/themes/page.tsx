 ...
 * Themes page — /themes
 *
 * Single canonical surface for browsing every Pharos theme. Renders the
...
export const metadata: Metadata = pageMetadata({
  title: 'Themes',
  description:
    'Browse and preview every Pharos theme and see how design tokens, type, and components restyle across the gallery.',
  path: '/themes',
});
...
async function SeededThemeExplorer({
  ...
  if (!seedPkg || !seedTheme) {
    // Defensive: only fires if the default theme package is
