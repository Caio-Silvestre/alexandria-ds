...
const BLOG_DESCRIPTION =
  'Notes on building Pharos — releases, guides, stories, and perspectives on designing a system for humans and agents.';
...
export const metadata: Metadata = {
  // Renders as "Blog · Pharos" via the root layout title template.
  title: BLOG_TITLE,
  description: BLOG_DESCRIPTION,
  openGraph: {
    type: 'website',
    title: `${BLOG_TITLE} · Pharos`,
    description: BLOG_DESCRIPTION,
    url: '/blog',
    images: ['./brand/logo/isolada_colorido.svg'],
  },
  twitter: {
