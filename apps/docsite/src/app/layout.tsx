...
// Note: the Pharos theme (src/themes/pharosTheme.ts) is Figtree-first.
...
const OG_IMAGE =
  './brand/logo/isolada_colorido.svg';

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: SITE_TITLE,
    // Per-page `title` values render as "<page> · Pharos".
    ...
    images: [
      {
        ...
        width: 2400,
        height: 1260,
        alt: 'Pharos — an open source design system by Meta',
      },
    ],
  },
  twitter: {
...
export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    // Server-render data-pharos-theme so the Pharos theme's @scope'd tokens (body
    ...
    <html lang="en" data-pharos-theme="pharos">
      <head>
