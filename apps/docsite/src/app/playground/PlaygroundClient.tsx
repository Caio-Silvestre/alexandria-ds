 ...
 * @position app/playground — the interactive Pharos code playground.
 *
 ...
 *   - Code: Monaco editor (controlled) with real Pharos .d.ts typedefs.
...
import {Tab, TabList} from '@pharos-ds/core/TabList';
...
import {useResizable, ResizeHandle} from '@pharos-ds/core/Resizable';
...
import {PharosIcon} from '../../components/logos';
...
import {tokenDefaults} from '@pharos-ds/core/theme';
...
export function PlaygroundClient() {
  ...
  const editorPanel = useResizable({
    ...
    minSizePx: 340,
    maxSizePx: 760,
    autoSaveId: 'pharos-playground-left-width',
  });
