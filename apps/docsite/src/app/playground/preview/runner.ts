 ...
 * global scope so unimported React hooks / Pharos components still resolve.
 */
 ...
 * Pharos components are available as globals without an explicit import.
 *
 ...
 *
 * Globals (every Pharos/icon export) are passed to `new Function` as parameters so
