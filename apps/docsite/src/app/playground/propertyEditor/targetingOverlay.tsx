...
import {Theme, MediaTheme} from '@pharos-ds/core/theme';
import type {ThemeMode} from '@pharos-ds/core/theme';
...
// content — it always renders on the site theme (Pharos) so it stays visually
...
function renderTargetLabel(label: HTMLDivElement) {
  ...
  root.render(
    <Theme theme={pharosTheme} mode={activeSiteMode}>
      <TargetLabel
        name={name}
 ...
 * intercepts pointer events to highlight hovered Pharos components and report
