...
const styles = stylex.create({
  siteFooter: {
    ...
    paddingTop:
      'var(--pharos-marketing-section-gap, calc(var(--spacing-12) * 2))',
  },
  pharosLogo: {
    height: 18,
    width: 'auto',
...
export function SiteFooter({year}: {year: number}) {
  ...
  const pharosLogo = (
    <Link href="/" label="Pharos">
      <PharosLogo aria-hidden="true" {...stylex.props(styles.pharosLogo)} />
    </Link>
  );
