...
// `@pharos-ds/theme-stone` → ['/theme-stone-preview.png', '/theme-stone-preview.jpg', …]
function themeImageCandidates(themeName: string): ReadonlyArray<string> {
  const slug = themeName.replace('@pharos-ds/theme-', '');
...
const styles = stylex.create({
  ...
  // Display, the theme-scoped .pharos-text.display-3 rule (legacy class selector;
          ...
          <VStack gap={6} width="100%" height="100%">
            ...
            <VStack gap={6} inert>
              {/* Typography samples — each "Aa" rendered in the theme's
                  ...
                  .pharos-text.display-3 selector (legacy class selector; e.g. Gothic →
            ...
            {/* Hero image — closing brand signature at the bottom
                ...
                Pharos provides Thumbnail but it's purpose-built
