 ...
 * Generated cover for release posts: the version in the Pharos brand blue on a
 * soft pastel-blue field, with the Pharos mark as the separator between
 * version segments and the package name beneath. Renders inline (not <img>).
 *
 * @input  version (e.g. "0.1.3"), packageName (defaults to @pharos-ds/core)
...
// Pharos mark (40x40 viewBox), mirrored from BlogCoverArt.
const MARK_PATH =
...
const DEFAULT_PACKAGE = '@pharos-ds/core';

// Same soft pastel blue as the landing feature cards.
const FIELD_BLUE = 'var(--pharos-marketing-feature-card-bg)';
