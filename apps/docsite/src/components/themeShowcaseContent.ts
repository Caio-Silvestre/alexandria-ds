 ...
 *
 * Keyed by theme slug (the `<slug>` in `@pharos-ds/theme-<slug>` / /themes?theme=<slug>).
 */
...
const MATCHA_IMAGES: Record<string, string> = {
  watch: demoImg('matcha-product-1'),
  headphones: demoImg('matcha-product-2'),
  backpack: demoImg('matcha-product-3'),
  wallet: demoImg('matcha-product-5'),
  tumbler: demoImg('matcha-product-4'),
  throw_: demoImg('matcha-product-6'),
};
...
const BUTTER_IMAGES: Record<string, string> = {
  watch: demoImg('Butter-Croissant'),
  headphones: demoImg('Butter-Pancake'),
  backpack: demoImg('Butter-Waffle'),
  wallet: demoImg('Butter-Toast'),
  tumbler: demoImg('Butter-Stick'),
  throw_: demoImg('Butter-Croissant'),
};
...
const STONE_IMAGES: Record<string, string> = {
  watch: demoImg('Stone-bowl'),
  headphones: demoImg('Stone-cup'),
  backpack: demoImg('Stone-plate'),
  wallet: demoImg('Stone-servingbowl'),
  tumbler: demoImg('Stone-teapot'),
  throw_: demoImg('Stone-vase'),
};
...
const Y2K_IMAGES: Record<string, string> = {
  watch: demoImg('Y2K-Phone'),
  headphones: demoImg('Y2K-Star'),
  backpack: demoImg('Y2K-Butterfly'),
  wallet: demoImg('Y2K-Heart'),
  tumbler: demoImg('Y2K-Flower'),
  throw_: demoImg('Y2K-Couch'),
};
...
const GOTHIC_IMAGES: Record<string, string> = {
  watch: demoImg('Gothic-1'),
  headphones: demoImg('Gothic-2'),
  backpack: demoImg('Gothic-3'),
  wallet: demoImg('Gothic-4'),
  tumbler: demoImg('Gothic-5'),
  throw_: demoImg('Gothic-6'),
};
