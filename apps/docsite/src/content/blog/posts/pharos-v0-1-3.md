---
title: 'Pharos v0.1.3: better tables, keyboard navigation, and accessibility'
...
Pharos v0.1.3 is out. This release is a big step forward for accessibility, keyboard navigation, and data tables. Install it with:

```bash
npm i @pharos-ds/core@0.1.3
```

All packages ship together at the same version, so bump every `@pharos-ds/*` package to `0.1.3` to match.
...
The full changelog is on the [v0.1.3 release page](https://github.com/Caio-Silvestre/alexandria-ds/releases/tag/v0.1.3).
