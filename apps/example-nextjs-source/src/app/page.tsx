...
import {Divider} from '@pharos-ds/core';
  ...
  return (
    <main {...stylex.props(styles.main)}>
      <div {...stylex.props(styles.container)}>
        <VStack gap={6}>
          <VStack gap={2}>
            <Heading level={1}>Pharos + Next.js (Source Build)</Heading>
              ...
              <VStack gap={4}>
                ...
                <VStack gap={1}>
                  <Text type="supporting" weight="bold">
                    1. pharos-base — default component styles
                  </Text>
                ...
                <VStack gap={1}>
                  <Text type="supporting" weight="bold">
                    2. pharos-theme — theme overrides base
                  </Text>
                ...
                <VStack gap={1}>
                  ...
                  <Text type="supporting" color="secondary">
                    Product styles use a different class prefix (x vs pharos) so
          ...
          <VStack gap={3}>
            ...
            <Text type="body" color="secondary">
              Inspect these elements in devtools. Pharos library classes start
              with <code>pharos</code>, product classes start with{' '}
              <code>x</code>.
            </Text>
            <Card padding={4}>
              <VStack gap={2}>
                <Text type="supporting" weight="bold">
                  This card is an Pharos component → pharos-prefixed classes
                </Text>
            ...
            <div {...stylex.props(styles.card)}>
              <VStack gap={2}>
                ...
                <Text type="body">
                  ...
                  <code>
                    reset &lt; pharos-base &lt; pharos-theme &lt; product
                  </code>
                </Text>
              </VStack>
            </div>
