  ...
  return (
    <main {...stylex.props(styles.main)}>
      <div {...stylex.props(styles.container)}>
        <VStack gap={6}>
          <VStack gap={2}>
            <Heading level={1}>Pharos + StyleX (Dist Build)</Heading>
            <Text type="body" color="secondary">
              ...
              layout styles, not to compile Pharos itself. Pharos handles
          ...
          <VStack gap={3}>
            ...
            <div {...stylex.props(styles.card)}>
              <Text type="body">
                This card uses StyleX for layout with Pharos design tokens via
                CSS custom properties. StyleX compiles your app styles at build
                time while Pharos component CSS comes pre-built from the dist
                package.
              </Text>
            </div>
          </VStack>
