  ...
  return (
    <main className="min-h-screen bg-body p-8">
      <div className="mx-auto max-w-3xl">
        <VStack gap={8}>
          <VStack gap={2}>
            <Heading level={1}>Pharos + Tailwind</Heading>
            <Text type="body" color="secondary">
              Pre-built dist package. No StyleX plugin needed. Tailwind handles
              layout, Pharos handles components and tokens.
            </Text>
          </VStack>

          <Divider />

          {/* Tailwind utilities on Pharos components */}
          <VStack gap={3}>
            <Heading level={2}>Tailwind on Pharos components</Heading>
          ...
          <VStack gap={3}>
            ...
            <Text type="supporting" color="secondary">
              ...
              , Pharos tokens become native Tailwind utilities. No{' '}
              <code className="rounded-sm bg-gray-100 px-1 py-0.5 text-xs">
                var()
              </code>{' '}
              needed.
          ...
          {/* Shadcn-style components alongside Pharos */}
          <VStack gap={3}>
