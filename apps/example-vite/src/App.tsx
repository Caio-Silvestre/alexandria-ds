    ...
    <Theme theme={neutralTheme}>
      <main {...stylex.props(styles.main)}>
        <div {...stylex.props(styles.container)}>
          <VStack gap={6}>
            <VStack gap={2}>
              <Heading level={1}>Pharos Example — Vite (Source)</Heading>
            ...
            <VStack gap={3}>
              ...
              <Text type="body" color="secondary">
                Product StyleX styles override Pharos component defaults via CSS
                ...
                <VStack gap={3}>
                  <VStack gap={1}>
                    <Text type="supporting" weight="bold">
                      Default Pharos buttons (pharos-base layer)
                    </Text>
                  ...
                  <VStack gap={1}>
                    ...
                    <Text type="supporting" color="secondary">
                      Secondary button background: Pharos base → theme override
            ...
            <VStack gap={3}>
              ...
              <div {...stylex.props(styles.card)}>
                <Text type="body">
                  ...
                  <code>@layer pharos-base</code> and{' '}
