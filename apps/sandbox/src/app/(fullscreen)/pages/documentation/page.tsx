    ...
    <div
      ...
      <aside
        ...
        <div
          ...
          <span style={{fontWeight: 700, fontSize: 18}}>Pharos</span>
        </div>
              ...
              <div style={{flex: 1, minWidth: 0}}>
                ...
                <div style={{marginTop: 16}}>
                  <Text type="large" color="secondary">
                    Pharos Web React is an open-source UI library created by the
                    Pharos Design Team to help developers quickly build
