 ...
 * see it live-validated against the @pharos-ds/core registry shipped as a
...
import {VStack, HStack} from '@pharos-ds/core/Stack';
...
import {checkExpression, expandExpression} from '@pharos-ds/cli/xle';
    ...
    <div {...stylex.props(s.page)}>
      <VStack gap={1}>
        ...
        <Text type="supporting">
          ...
          XLO). It is validated live against @pharos-ds/core; the expanded TSX
          and token counts update below. The whole pipeline runs in-browser via
          the @pharos-ds/cli/xle barrel.
        </Text>
      </VStack>
