...
import type {BadgeVariant} from '@pharos-ds/core/Badge';
...
const waitingForAWhile: ReviewRow[] = [
  {
    id: '1',
    title: '[pharos][FilterTokenList]: Promote out of beta',
    prId: 'PR-1042',
    lines: 3,
  ...
  {
    id: '2',
    title: '[pharos][Table] Fix column resize regression on Safari',
    prId: 'PR-1038',
    lines: 47,
...
const needsCodeReview: ReviewRow[] = [
  {
    id: '3',
    title: '[pharos][Avatar] Add AvatarStatusDot size scaling',
    prId: 'PR-1055',
    lines: 128,
  ...
  {
    id: '4',
    title: '[pharos][Badge] Introduce error variant with icon slot',
    prId: 'PR-1061',
    lines: 52,
  ...
  {
    id: '5',
    title: '[pharos][Collapsible] Animate height transitions with CSS',
    prId: 'PR-1063',
    lines: 210,
  ...
  {
    id: '6',
    title: '[pharos][TextInput] Add clearable prop with trailing icon',
    prId: 'PR-1067',
    lines: 34,
  ...
  {
    id: '7',
    title: '[pharos][Layout] Support sticky header in LayoutHeader',
    prId: 'PR-1070',
    lines: 89,
...
const acceptedAndReady: ReviewRow[] = [
  {
    id: '8',
    title: '[pharos][StatusDot] Add isPulsing animation support',
    prId: 'PR-1048',
    lines: 22,
  ...
  {
    id: '9',
    title: '[pharos][Card] Add isFullBleed prop for edge-to-edge content',
    prId: 'PR-1051',
    lines: 15,
    reviewTime: '<20sec review',
