...
export const metadata: Metadata = {
  title: 'Pharos Sandbox',
  description: 'Pharos component testing sandbox',
};
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{if(window.self!==window.top)document.documentElement.classList.add('pharos-embed')}catch(e){document.documentElement.classList.add('pharos-embed')}`,
          }}
        />
        <style
          dangerouslySetInnerHTML={{
            __html: `html.pharos-embed [data-preview-shell]{display:none!important}`,
          }}
        />
      </head>
      <body>
