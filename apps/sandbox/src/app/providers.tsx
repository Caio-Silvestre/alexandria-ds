...
import {LayerProvider} from '@pharos-ds/core/Layer';
import {neutralTheme} from '@pharos-ds/theme-neutral/built';
import {matchaTheme} from '@pharos-ds/theme-matcha/built';
...
import type {DefinedTheme, ThemeMode} from '@pharos-ds/core/theme';
...
const THEME_STORAGE_KEY = 'pharos-sandbox-theme';
const MODE_STORAGE_KEY = 'pharos-sandbox-mode';
...
export function Providers({children}: {children: React.ReactNode}) {
  ...
  useEffect(() => {
    ...
    const handler = (event: MessageEvent) => {
      if (event.data?.type === 'pharos-theme-sync') {
