...
export const categories: SandboxCategory[] = [
    ...
    pages: [
      {
        ...
        description:
          'Pharos components showcased in realistic card compositions',
      },
      {
        name: 'Table Overview',
  ...
  },
  {
    ...
    slug: 'templates',
    description:
      'Full-page application templates — dashboards, forms, and data views built with Pharos.',
    pages: [
  ...
  },
  {
    ...
    slug: 'tools',
    description:
      'Interactive tools for building and exploring Pharos components.',
    pages: [
      {
        name: 'Layout DSL',
