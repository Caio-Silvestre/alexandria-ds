  ...
  viteFinal: async config => {
    ...
    return {
      ...
      optimizeDeps: {
        ...
        // pre-bundled deps. The StyleX Babel plugin stalls on some Pharos core
        ...
        ...pharosStylex({
          stylexOptions: {
            ...
            aliases: {
              ...
              '@pharos-ds/core': [path.join(rootDir, 'packages/core/src')],
              '@pharos-ds/lab/*': [path.join(rootDir, 'packages/lab/src/*')],
              '@pharos-ds/lab': [path.join(rootDir, 'packages/lab/src')],
              '@pharos-ds/charts/*': [
      ...
      resolve: {
        ...
        alias: {
          ...
          '@pharos-ds/core': path.resolve(rootDir, 'packages/core/src'),
          '@pharos-ds/lab': path.resolve(rootDir, 'packages/lab/src'),
          '@pharos-ds/charts': path.resolve(rootDir, 'packages/charts/src'),
          '@pharos-ds/theme-neutral': path.resolve(
            rootDir,
            'packages/themes/neutral/src/source.ts',
          ),
          '@pharos-ds/theme-stone': path.resolve(
            rootDir,
            'packages/themes/stone/src/source.ts',
          ),
          '@pharos-ds/theme-y2k': path.resolve(
            rootDir,
            'packages/themes/y2k/src/source.ts',
          ),
          '@pharos-ds/vega': path.resolve(rootDir, 'packages/vega/src'),
        },
      },
      css: {
