 ...
 *   buttons only (via the `pharos-calendar-nav` target), instead of the global
 *   `pharos-button` handle that would hit every Button in the app. The
 ...
 *   (the `pharos-calendar-day` target with its `selected` state).
 */
