...
import {
  ...
  defineSyntaxTheme,
} from '@pharos-ds/core/theme/syntax';
import {defineTheme, Theme} from '@pharos-ds/core/theme';
import {
  oneDarkPro,
  dracula,
  monokai,
    ...
    docs: {
      description: {
        component:
          ...
          'to apply community syntax color themes. 12 presets ship in @pharos-ds/core/theme/syntax.',
      },
    },
  },
};
