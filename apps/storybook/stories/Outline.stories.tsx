...
const markdownContent = [
  '## Overview',
  '',
  'Pharos gives teams a consistent foundation for internal product surfaces.',
  '',
  '## Installation',
  '',
    ...
    <div
      ...
      <article style={{display: 'grid', gap: 24}}>
        <section>
          ...
          <p>
            Pharos components provide consistent interaction, styling, and theme
        ...
        <section>
          ...
          <p>
            Component overrides target the stable Pharos selector surface
            emitted by each component: pharos-* classes plus data-* prop
            reflections.
          </p>
        </section>
        <section>
