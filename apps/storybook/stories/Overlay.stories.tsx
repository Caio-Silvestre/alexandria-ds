...
import {Overlay, useOverlay} from '@pharos-ds/core/Overlay';
...
const SAMPLE_IMAGE = 'https://picsum.photos/seed/pharos-overlay/800/450';
const SAMPLE_IMAGE_2 = 'https://picsum.photos/seed/pharos-overlay-2/800/450';
const SAMPLE_IMAGE_3 = 'https://picsum.photos/seed/pharos-overlay-3/800/450';
const SAMPLE_HERO = 'https://picsum.photos/seed/pharos-hero/1200/600';
      ...
      <Overlay
        ...
        content={
          <VStack gap={2} hAlign="center">
            ...
            <Text weight="bold">Introduction to Pharos</Text>
          </VStack>
        }>
        <AspectRatio ratio={16 / 9}>
