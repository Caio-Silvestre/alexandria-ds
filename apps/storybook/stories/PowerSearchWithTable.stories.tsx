...
import {Table, pixel, proportional} from '@pharos-ds/core/Table';
import type {TableColumn} from '@pharos-ds/core/Table';
import type {SearchSource, SearchableItem} from '@pharos-ds/core/Typeahead';
...
// the same @pharos.powersearch.operator.* i18n keys as enum_list.
// -----------------------------------------------------------------------------
