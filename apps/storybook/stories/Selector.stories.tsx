...
import {Selector, SelectorOption} from '@pharos-ds/core/Selector';
 ...
 *   itself (via the `pharos-selector-clear-icon` target), so a theme can
 ...
 *
 * Same-element rules in `@layer pharos-theme` win over each icon's own base
 * color/size.
 */
