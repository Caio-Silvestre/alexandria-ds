...
import {VegaChart, buildVegaLiteConfig} from '@pharos-ds/vega';
import type {AnySpec} from '@pharos-ds/vega';
import {useTheme} from '@pharos-ds/core';
...
// ---------------------------------------------------------------------------
// Themed wrapper — resolves Pharos tokens into a Vega-Lite config
// ---------------------------------------------------------------------------
