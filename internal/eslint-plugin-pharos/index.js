...
/**
 * @file ESLint plugin for Pharos design system
 * @description Enforces usage of design tokens and Pharos conventions
 *
 * Rules:
...
// Detects hardcoded CSS values that should use Pharos tokens
// =============================================================================
...
const noHardcodedStylesRule = {
  meta: {
    type: 'suggestion',
    docs: {
      description: 'Enforce usage of Pharos design tokens instead of hardcoded values in StyleX',
...
plugin.configs.strict = {
  ...
  rules: {
    ...
    '@pharos-ds/boolean-prop-naming': 'error',
    '@pharos-ds/presentational-component': 'error',
    '@pharos-ds/docblock-example-format': 'error',
    '@pharos-ds/no-stylex-null-override': 'error',
    '@pharos-ds/no-react-introspection': 'error',
    '@pharos-ds/no-classname-clobber': 'error',
    '@pharos-ds/no-hardcoded-anchor': 'error',
    '@pharos-ds/no-raw-paragraph': 'error',
    '@pharos-ds/no-border-shorthand': 'error',
    ...
    '@pharos-ds/no-physical-properties': 'warn',
    '@pharos-ds/no-react-namespace-hooks': 'error',
    '@pharos-ds/require-base-props': 'error',
    '@pharos-ds/require-ref-prop': 'error',
    '@pharos-ds/copyright-header': 'error',
    '@pharos-ds/no-hardcoded-i18n-string': 'error',
    '@pharos-ds/i18n-key-format': 'error',
  },
};
...
plugin.configs.recommended = {
  ...
  rules: {
    ...
    '@pharos-ds/boolean-prop-naming': 'warn',
    '@pharos-ds/presentational-component': 'error',
    '@pharos-ds/docblock-example-format': 'warn',
    '@pharos-ds/no-stylex-null-override': 'warn',
    '@pharos-ds/no-react-introspection': 'error',
    '@pharos-ds/no-classname-clobber': 'error',
    '@pharos-ds/no-hardcoded-anchor': 'warn',
    '@pharos-ds/no-raw-paragraph': 'warn',
    '@pharos-ds/no-border-shorthand': 'warn',
    // Warn now, flip to error after RTL Phase 4 (Calendar/Slider/Table)
    // physical-property migration lands.
    '@pharos-ds/no-physical-properties': 'warn',
    '@pharos-ds/no-react-namespace-hooks': 'error',
    '@pharos-ds/require-base-props': 'warn',
    '@pharos-ds/require-ref-prop': 'warn',
    '@pharos-ds/copyright-header': 'error',
    '@pharos-ds/no-hardcoded-i18n-string': 'warn',
    '@pharos-ds/i18n-key-format': 'warn',
  },
};
