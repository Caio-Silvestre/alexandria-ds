 ...
 *
 * @see https://github.com/Caio-Silvestre/alexandria-ds/wiki/API-Conventions
 */
...
const noReactIntrospectionRule = {
  meta: {
    ...
    docs: {
      ...
      category: 'Pharos Architecture',
      recommended: true,
      url: 'https://github.com/Caio-Silvestre/alexandria-ds/wiki/API-Conventions',
    },
    messages: {
      childrenMethod:
