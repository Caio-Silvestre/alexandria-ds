...
Automates the "screenshot with in-context tags" flow for [Crowdin](https://crowdin.com/), the translation platform used by pharos.
...
```js
{
  ...
  manualTags: [
    t('pharos.dialog.close', 'ariaLabel', 'Close'),
  ],
}
```
