...
// Load identifier → stringId map for every pharos.* string. Cached across
...
async function loadStringIdMap(token) {
  ...
  const limit = 500;
  while (true) {
    // Filter by prefix "pharos." to reduce the payload; we tag nothing else.
    const q = `/projects/${PROJECT_ID}/strings?filter=${encodeURIComponent('pharos.')}&scope=identifier&limit=${limit}&offset=${offset}`;
...
//   { key: 'pharos.foo.bar', strategy: 'option', args: ['Contains'] }
...
const TARGETS = [
  ...
  // ==========================================================================
  {
    ...
    manualTags: [
      t('pharos.powersearch.operator.isAnyOf', 'chipOperator', 'Status'),
      t('pharos.powersearch.operator.is', 'chipOperator', 'Priority'),
      t('pharos.powersearch.operator.contains', 'chipOperator', 'Title'),
      t('pharos.powersearch.operator.isAnyOf', 'chipOperator', 'Assignee'),
      t('pharos.powersearch.operator.greaterThan', 'chipOperator', 'Line count'),
      t('pharos.powersearch.operator.after', 'chipOperator', 'Created'),
    ],
  },
  {
    ...
    manualTags: [
      ...
      t('pharos.powersearch.operator.after', 'visibleText'),
      // Date value input placeholder (from @pharos-ds/core's DateTimeInput).
      t('pharos.dateTimeInput.placeholder', 'placeholder'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.chat.status.sending', 'visibleText'),
      t('pharos.chat.status.sent', 'visibleText'),
      t('pharos.chat.status.delivered', 'visibleText'),
      t('pharos.chat.status.read', 'visibleText'),
      t('pharos.chat.status.failed', 'visibleText'),
    ],
  },
  {
    ...
    manualTags: [
      ...
      t('pharos.powersearch.resultCount', 'visibleText', '1,234 results'),
    ],
  },
  {
    ...
    manualTags: [
      ...
      t('pharos.pagination.count', 'visibleText', '1–20 of 200'),
    ],
  },
  {
    ...
    manualTags: [
      // "Page {n} of {total}"
      t('pharos.pagination.pageOfTotal', 'visibleText', 'Page 1 of 10'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.pagination.count', 'visibleText', '1–10 of 200'),
      ...
      t('pharos.pagination.itemsPerPage', 'srOnlyReveal', undefined, 'below'),
    ],
  },
  ...
  // ==========================================================================
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.powersearch.operator.contains', 'option'),
      t('pharos.powersearch.operator.notContains', 'option'),
      t('pharos.powersearch.operator.startsWith', 'option'),
      t('pharos.powersearch.operator.notStartsWith', 'option'),
      t('pharos.powersearch.operator.endsWith', 'option'),
      t('pharos.powersearch.operator.notEndsWith', 'option'),
      t('pharos.powersearch.operator.is', 'option'),
      t('pharos.powersearch.operator.isNot', 'option'),
      t('pharos.powersearch.valueEditor.enterValuePlaceholder', 'placeholder', 'Enter value'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  {
    ...
    manualTags: [
      t('pharos.powersearch.operator.equals', 'option'),
      t('pharos.powersearch.operator.notEquals', 'option'),
      t('pharos.powersearch.operator.greaterThan', 'option'),
      t('pharos.powersearch.operator.lessThan', 'option'),
      t('pharos.powersearch.operator.greaterThanOrEqual', 'option'),
      t('pharos.powersearch.operator.lessThanOrEqual', 'option'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  {
    ...
    manualTags: [
      t('pharos.powersearch.operator.is', 'option'),
      t('pharos.powersearch.operator.isNot', 'option'),
      t('pharos.powersearch.operator.isAnyOf', 'option'),
      t('pharos.powersearch.operator.isNoneOf', 'option'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  ...
  // ==========================================================================
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.powersearch.operator.before', 'option'),
      t('pharos.powersearch.operator.after', 'option'),
      t('pharos.powersearch.operator.between', 'option'),
      t('pharos.dateTimeInput.placeholder', 'placeholder'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.powersearch.operator.isTrue', 'chipOperator', 'In Stock'),
      t('pharos.powersearch.operator.isFalse', 'chipOperator', 'Discontinued'),
    ],
  },
  {
    ...
    manualTags: [
      t('pharos.powersearch.operator.isAnyOf', 'option'),
      t('pharos.powersearch.operator.isNoneOf', 'option'),
      t('pharos.powersearch.valueEditor.selectValuesPlaceholder', 'placeholder', 'Select values'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  ...
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.powersearch.operator.isAnyOf', 'visibleText'),
      t('pharos.powersearch.valueEditor.searchPlaceholder', 'placeholder', 'Search'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.powersearch.operator.contains', 'visibleText'),
      t('pharos.powersearch.valueEditor.enterValuePlaceholder', 'placeholder', 'Enter value'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  {
    ...
    manualTags: [
      ...
      t('pharos.powersearch.operator.equals', 'visibleText'),
      t('pharos.powersearch.valueEditor.enterNumberPlaceholder', 'placeholder', 'Enter number'),
      t('pharos.powersearch.editor.cancel', 'footerButton'),
      t('pharos.powersearch.editor.apply', 'footerButton'),
    ],
  },
  ...
  // ==========================================================================
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.dialog.close', 'srOnlyReveal', undefined, 'left'),
    ],
  },
  {
    ...
    manualTags: [
      ...
      t('pharos.alertDialog.cancel', 'footerButton'),
    ],
  },
  ...
  // ==========================================================================
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.banner.dismiss', 'srOnlyReveal', undefined, 'below'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.banner.expand', 'srOnlyReveal', undefined, 'below'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.banner.collapse', 'srOnlyReveal', undefined, 'below'),
    ],
  },
  ...
  // ==========================================================================
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.table.sort.ascending', 'visibleText'),
      t('pharos.table.sort.descending', 'visibleText'),
      t('pharos.table.sort.clear', 'visibleText'),
    ],
  },
  {
    name: 'table-selection',
    // Select-all / select-row labels are sr-only <label> elements
    // (pharos-field-label at 1×1 px). srOnlyLabel walks up to the nearest
    ...
    selector: null,
    manualTags: [
      t('pharos.table.selection.selectAllRows', 'srOnlyReveal', undefined, 'below'),
      t('pharos.table.selection.selectRow', 'srOnlyReveal', undefined, 'right'),
    ],
  },
  {
    ...
    manualTags: [
      ...
      t('pharos.table.filter.allPlaceholder', 'visibleText'),
      t('pharos.table.filter.reset', 'footerButton'),
      t('pharos.table.filter.apply', 'footerButton'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.tableRowExpansion.expandRow', 'srOnlyReveal', undefined, 'right'),
      t('pharos.tableRowExpansion.collapseRow', 'srOnlyReveal', undefined, 'right'),
      t('pharos.tableRowExpansion.expandAllRows', 'srOnlyReveal', undefined, 'below'),
    ],
  },
  {
    ...
    selector: null,
    manualTags: [
      t('pharos.tableGroupedRows.collapseGroup', 'srOnlyReveal', 'Collapse group Design Systems', 'right'),
      t('pharos.tableGroupedRows.expandGroup', 'srOnlyReveal', 'Expand group Infra', 'right'),
    ],
  },
];
...
async function ensureStorybookBuild() {
  ...
  log('Building Storybook (pnpm --filter @pharos-ds/storybook build)…');
  const t0 = Date.now();
  run('pnpm --filter @pharos-ds/storybook build', {cwd: REPO_ROOT});
...
async function main() {
  ...
  log(`  loaded ${stringIdMap.size} pharos.* identifiers`);
