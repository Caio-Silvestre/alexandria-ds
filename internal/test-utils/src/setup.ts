...
// Text queries (getByText/findByText/…) target VISIBLE text. Pharos's
// `useAnnounce` renders a visually-hidden aria-live region
// (`data-pharos-live-region`) that MIRRORS visible labels for screen readers —
...
configure({defaultIgnore: 'script, style, [data-pharos-live-region]'});
