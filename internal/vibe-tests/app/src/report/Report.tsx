...
import {Tab} from '@pharos-ds/core/TabList';
            ...
            <div className="report-tabContent">
              {activeTab === 'overview' && (
                <VStack gap={4}>
                  ...
                  {comparison?.pharosTailwind && (
                    <ScoreCard
                      label="Overall Score vs Pharos+TW"
                      score={universal.overall}
                      compareScore={comparison.pharosTailwind.overall}
                      compareLabel="Pharos+TW"
                    />
                  )}
                    ...
                    <VStack gap={3}>
                      <Heading level={3}>
                        {[
                          ...
                          comparison.pharosTailwind ? 'Pharos+TW' : null,
                        ]
                          .filter(Boolean)
                          .join(' vs ')}{' '}
                        Comparison
                  ...
                  <VStack gap={3}>
                    ...
                    {Object.keys(universal.byPrompt).map(promptId => (
                      <PromptDetailCard
                        ...
                        hasXdsTailwindCode={
                          !!data.pharosTailwindSourceCode?.[promptId]
                        }
              ...
              {codeModal &&
                (() => {
                  const code =
                    codeModal.target === 'pharos'
                      ? data.sourceCode?.[codeModal.promptId]
                      : codeModal.target === 'baseline'
                        ? data.baselineSourceCode?.[codeModal.promptId]
                        : codeModal.target === 'pharos-tailwind'
                          ? data.pharosTailwindSourceCode?.[codeModal.promptId]
