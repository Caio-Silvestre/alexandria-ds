 ...
 *
 * Supports BOTH StyleX (for Pharos component internals) AND Tailwind
 * (for consumer code in Pharos+Tailwind results). Pharos components use
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@pharos-ds/core': path.resolve(repoRoot, 'packages/core/src'),
