 ...
 *
 * Reports use pre-compiled CSS from @pharos-ds/core/dist/pharos.css and
 * @pharos-ds/theme-neutral/dist/theme.css. Pharos component JS is loaded from
...
export default defineConfig({
  ...
  build: {
    // The bundled @pharos-ds/core (Babel output) uses modern syntax that
  ...
  resolve: {
    alias: [
      ...
      {
        find: 'pharos-css',
        replacement: path.resolve(repoRoot, 'packages/core/dist/pharos.css'),
      },
      {
        find: 'pharos-theme-css',
