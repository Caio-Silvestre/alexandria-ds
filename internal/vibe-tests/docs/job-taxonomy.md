...
| Source              | Description                                 |
| ------------------- | ------------------------------------------- |
| **AGENTS.md**       | Component catalog and Pharos guidance       |
...
| ------------------------ | ------------------------------------------- | --------- |
| **Component Routing**    | Import statements for Pharos components     | 3-10%     |
| **Component Config**     | Props and attributes on Pharos components   | 7-30%     |
...
**Import statements for Pharos components**
...
**Props and attributes on Pharos components**
...
- **AGENTS.md**: Always read (~173 tokens) - component catalog and Pharos guidance
...
- Pharos component JSX with props → Component Config
