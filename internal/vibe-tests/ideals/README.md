...
- **Source:** Figma mockup or hand-built HTML, NOT generated by any of the 3 targets (Pharos, baseline, HTML)
- **Review:** At least one designer should review the ideal before committing

## Current Ideals

55 prompt IDs covered (62 images total). See [issue #733](https://github.com/Caio-Silvestre/alexandria-ds/issues/733) for context.
