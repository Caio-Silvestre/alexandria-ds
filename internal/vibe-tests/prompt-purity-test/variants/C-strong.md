STOP — MANDATORY SELF-AUDIT before you output the final file. Pharos is the ONLY
...
2. For EACH hit: delete it and use the Pharos component (layout, spacing, surfaces,
...
3. If you are not 100% sure a component/prop exists, you MUST verify with
   `pharos component <Name>` or `pharos search "<thing>"` — do NOT guess and do NOT
   fall back to CSS.
