...
check "skill doc generated" test -f .generated/pharos-skill.md

# Create tasks for 1 prompt
OUTPUT=$(pnpm --silent interactive --target pharos --persona naive --sample 1 2>&1)
...
import {Card} from '@pharos-ds/core';
import {Text} from '@pharos-ds/core';
import {Heading} from '@pharos-ds/core';
import {VStack} from '@pharos-ds/core';
...
FIXTURE2_META
    ...
    # Run compare
    CMP_OUTPUT=$(pnpm --silent compare --pharos "$ITER_ID" --baseline "$ITER_ID2" 2>&1)
    CMP_EXIT=$?
