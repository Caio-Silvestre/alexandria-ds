...
# GitHub Pages base URL for the Pharos repo
GH_PAGES_BASE = "https://pharos-ds.vercel.app"
...
def build_comment(data, iteration_id_override=None):
    ...
    for pid, pd in sorted(results.items()):
        ...
        if has_baseline:
            lines.append("**Ideal** | **Pharos** | **Baseline** | **HTML**")
            lines.append(":--: | :--: | :--: | :--:")
            lines.append(
                f'<img src="{ideal_url(f"{pid}.png")}" width="220"> | '
                f'<img src="{img_url(iteration_id, f"{pid}-pharos-desktop-light.png")}" width="220"> | '
            ...
            lines.append("**Ideal** | **Pharos** | **HTML**")
            lines.append(":--: | :--: | :--:")
            lines.append(
                f'<img src="{ideal_url(f"{pid}.png")}" width="220"> | '
                f'<img src="{img_url(iteration_id, f"{pid}-pharos-desktop-light.png")}" width="220"> | '
...
def main():
    ...
    p.add_argument("--repo", default="facebook/pharos", help="GitHub repo")
