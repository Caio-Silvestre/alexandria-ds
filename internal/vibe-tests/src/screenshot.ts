...
function generatePreviewCode(
  ...
  target: 'pharos' | 'baseline' | 'pharos-tailwind',
): string {
...
async function main() {
  ...
  // Use the preview config for pharos-tailwind (includes PostCSS/Tailwind),
