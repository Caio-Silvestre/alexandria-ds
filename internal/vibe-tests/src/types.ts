...
export type TargetName = 'pharos' | 'pharos-tailwind' | 'baseline' | 'html';

export interface UniversalComparison {
  pharos: UniversalAggregate;
  baseline: UniversalAggregate;
  html?: UniversalAggregate;
  pharosTailwind?: UniversalAggregate;
  winners: Record<UniversalDimension, TargetName | 'tie'>;
  byPrompt: Record<
    string,
    {
      pharos: UniversalScore;
      baseline: UniversalScore;
      html?: UniversalScore;
      pharosTailwind?: UniversalScore;
