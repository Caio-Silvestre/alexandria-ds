 ...
 * different classNamePrefix for Pharos library files vs product files.
 *
 * Library files get 'pharos' prefix (.pharos78zum5), product files get 'x' (.x78zum5).
 */
...
module.exports = function pharosBabelPlugin(api, options) {
