...
/**
 * @pharos-ds/postcss-plugin
 *
 * PostCSS plugin for Pharos source builds. Compiles StyleX from both
 * Pharos library source and product code in two separate passes with
 * different class name prefixes, then outputs them in separate layers:
 *
 *   reset < pharos-base (library, prefix: 'pharos') < pharos-theme < product (prefix: 'x')
 *
...
const PLUGIN_NAME = '@pharos-ds/postcss-plugin';

const LIBRARY_GLOB = 'node_modules/@pharos-ds/**/*.{ts,tsx}';
const LIBRARY_PATTERNS = ['node_modules/@pharos-ds/', 'packages/core/', 'packages/themes/'];
