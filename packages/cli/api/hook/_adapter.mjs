 ...
 * hook.detail.params) need to (a) locate @pharos-ds/core and (b) resolve a
 ...
 *
 * @input  cwd, hook name
 * @output resolved core dir / loaded HookDoc (or a thrown PharosError)
...
/**
 * Locate the @pharos-ds/core package directory, or throw the same
