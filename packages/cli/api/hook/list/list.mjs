        ...
        if (docPath) {
          try {
            ...
            entries.push({
              ...
              import: docs.importPath || '@pharos-ds/core/hooks',
            });
          } catch {
            entries.push({name: hookName, description: '', import: '@pharos-ds/core/hooks'});
          }
        } else {
          entries.push({name: hookName, description: '', import: '@pharos-ds/core/hooks'});
        }
      ...
      for (const hookName of hookNames) {
        ...
        if (docPath) {
          try {
            ...
            result[cat].push({name: hookName, description: '', import: '@pharos-ds/core/hooks'});
          }
        } else {
          result[cat].push({name: hookName, description: '', import: '@pharos-ds/core/hooks'});
        }
