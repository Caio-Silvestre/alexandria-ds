...
/**
 * @file Programmatic API for the Pharos CLI.
 *
 * Every function returns the same { type, data } envelope that `xds --json` outputs.
 * Errors throw PharosError (with optional .suggestions).
 *
 * @example
 * import { component, docs, hook, PharosError } from '@pharos-ds/cli/api';
 *
...
export {PharosError} from './error.mjs';
