 ...
 * `pharos init`. It installs the AGENTS.md/CLAUDE.md agent-docs cheat sheet,
 ...
 * `init.run` receipt. Hard errors (unknown feature/template) throw PharosError
...
/**
 * Build the "Next steps" lines printed at the end of `pharos init`.
 *
 ...
 * path. See https://github.com/Caio-Silvestre/alexandria-ds/issues/3080.
 *
 * @param {string} invocation install-aware CLI invocation stem (e.g. `npx pharos`, `pnpm exec pharos`, or `npx @pharos-ds/cli` for one-off runs)
...
export function getNextSteps(invocation) {
  return [
    '',
    '  Next steps:',
    "    1. Import base styles: import '@pharos-ds/core/reset.css'",
    "       and import '@pharos-ds/core/pharos.css'",
    "    2. Import components: import { Button } from '@pharos-ds/core'",
 ...
 * names throw PharosError with a stable code.
 *
 * @param {import('../../../types/api').InitOptions} [options]
