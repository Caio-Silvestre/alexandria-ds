...
/**
 * @file `pharos layout expand` leaf — expand a validated layout expression into
...
/**
 * `pharos layout expand "<expr>" [path]`
 *
  ...
  if (targetPath) {
    ...
    try {
      ...
      if (err instanceof PathSafetyError) {
        throw new PharosError(err.message, undefined, ERROR_CODES.ERR_PATH_TRAVERSAL);
      }
      throw err;
    }
