 ...
 * throw PharosError (stable code + suggestions). All human prose /
...
const DEFAULT_ISSUES_URL = 'https://github.com/Caio-Silvestre/alexandria-ds/issues/new';
 ...
 * left untouched.
 *
 * e.g. with ownerPackage '@pharos-ds/core':
 *      '../theme/tokens.stylex' -> '@pharos-ds/core/theme'
 *      '../utils/mergeProps'     -> '@pharos-ds/core/utils'
 *
...
export async function swizzleCopy(component, options = {}) {
  ...
  try {
    ...
    if (err instanceof PathSafetyError) {
      throw new PharosError(err.message, [], ERROR_CODES.ERR_PATH_TRAVERSAL);
    }
    throw err;
  }
