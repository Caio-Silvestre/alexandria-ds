 ...
 * `pharos theme build` (`@pharos-ds/cli/api`).
 *
 ...
 *
 * `themeBuild` compiles via @pharos-ds/core's generator, so it needs a built
...
vi.mock('@pharos-ds/core/theme', async importActual => {
...
let tmpDir;
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'pharos-theme-build-api-'));
});
afterEach(() => {
