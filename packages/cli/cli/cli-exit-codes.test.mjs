...
describe('exit codes — error paths (--json → exit 1, valid envelope)', () => {
  it('pharos bogus-cmd --json → exit 1, error envelope', async () => {
  ...
  it('pharos component bogus --json → exit 1, error envelope', async () => {
  ...
  it('pharos hook bogus --json → exit 1, error envelope', async () => {
  ...
  it('pharos docs bogus --json → exit 1, error envelope', async () => {
