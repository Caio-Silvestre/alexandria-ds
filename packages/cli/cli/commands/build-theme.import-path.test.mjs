...
/**
 * @file Regression test for `pharos theme build` install-instructions import paths.
 *
...
// `pharos theme build` imports the compiled @pharos-ds/core/theme entry (there is no
...
let tmpDir;
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'pharos-build-theme-import-path-'));
});
afterEach(() => {
