...
/**
 * @file Guardrail tests for the @pharos-ds/cli postinstall nudge (layer 2).
 *
...
const DEP = '/proj/node_modules/@pharos-ds/cli/scripts/postinstall.mjs'; // real dep install
const NPX = '/Users/x/.npm/_npx/a1b2/node_modules/@pharos-ds/cli/scripts/postinstall.mjs';
