...
// under `node_modules`, so a real pharos.config.mjs at a tmp root cannot be
 ...
 * - packages/core symlinked to the real @pharos-ds/core (loadDocs source)
...
beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'pharos-ownership-'));
