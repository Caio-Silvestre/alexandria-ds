...
/**
 * @file discover command — find external Pharos packages and components
 *
 * Usage:
 *   pharos discover                           List all packages
 *   pharos discover @scope/name               List components in a package
 *   pharos discover @scope/name/Component     Show docs for a component
 *   pharos discover searchterm                Search across all packages
 */
        ...
        case 'discover.list': {
          if (result.data.length === 0) {
            ...
            if (result.meta && result.meta.configured === false) {
              ...
              humanLog('');
              humanLog('Add integration package names to pharos.config.mjs:');
              humanLog('');
