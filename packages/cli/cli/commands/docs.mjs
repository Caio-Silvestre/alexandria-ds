...
/**
 * @file docs command — Print Pharos reference docs
 *
 * Auto-discovers .doc.mjs files from the docs/ directory.
 * Supports --detail (full|compact|brief) and --lang (en|zh|dense).
 *
 * Usage:
 *   pharos docs                          List available topics
 *   pharos docs <topic>                  Print full doc
 *   pharos docs <topic> <section>        Print one section
 */
