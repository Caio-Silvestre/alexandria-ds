...
/**
 * @file `pharos doctor` command — diagnose a project + environment and report
 ...
 * FAILs (warnings are fine), 1 when any check FAILs — so `pharos doctor` works
 * as a CI gate.
 */
...
function printHuman(report) {
  humanLog('pharos doctor — diagnosing your setup\n');
...
/**
 * Register the `pharos doctor` command.
