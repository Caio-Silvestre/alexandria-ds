 ...
 *
 * `pharos init` is non-interactive by default: it installs the AGENTS.md/
 ...
 * Non-interactive feature install: `pharos init --features agents,theme,template`
  ...
  program
    ...
    .action(async (/** @type {import('../../api/init/init.mjs').InitOptions} */ options) => {
      ...
      try {
        ...
        const e = /** @type {import('../../api/error.mjs').PharosError} */ (err);
