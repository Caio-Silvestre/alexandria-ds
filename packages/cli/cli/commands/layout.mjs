 ...
 *
 * Subcommands:
 *   pharos layout expand "<expr>" [path]   compressed expression → validated TSX
 *   pharos layout check "<expr>"           validate + echo both canonical surfaces
 *   pharos layout grammar                  agent cheatsheet (alias table is branch-generated)
 *
