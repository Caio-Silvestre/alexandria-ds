 ...
 *
 * Usage:
 *   pharos search button                 Ranked results across all domains
 *   pharos search modal --type component Filter to a single domain
 *   pharos search forms --limit 5        Cap the result count
 *   pharos search button --detail        Verbose (include import / reason)
 *   pharos search button --json          Typed JSON envelope
 */
