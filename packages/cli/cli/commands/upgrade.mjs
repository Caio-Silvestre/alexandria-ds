 ...
 *
 * `pharos upgrade` runs codemods that migrate source between Pharos versions and
 ...
 *
 * Consumers bump/install their Pharos packages first, then run:
 *   pharos upgrade --from <old-version> --path <source-dir> --apply
 */

import {jsonOut, jsonError} from '../../lib/json.mjs';
import {termLogger, noopLogger} from '../../lib/term-log.mjs';
import {PharosError} from '../../api/error.mjs';
    ...
    .action(
      ...
      async options => {
        ...
        try {
          ...
          // Handled failures throw PharosError: --json emits the structured
          ...
          // top-level boundary in bin/pharos.mjs format it as before.
          if (e instanceof PharosError) {
