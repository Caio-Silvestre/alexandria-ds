 ...
 * Config codemods target the consumer's pharos.config.* file; code codemods
 ...
 * implementation of "run a config codemod against pharos.config.*" and "run a
 ...
 * first (targeting pharos.config.*), then code codemods (source globbing).
 *
