...
export default [
  {
    ...
    // the specifier codemod then rewrites the paths to `@pharos-ds/core`.
  ...
  },
  {
    ...
    // codemod: it uses the same @xds -> @pharos-ds mapping and repairs an
  ...
  },
  {
    ...
    // become their `pharos-*` forms. Mandatory in v0.1.0.
