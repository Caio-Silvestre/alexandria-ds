...
/**
 * @file Codemod: migrate module specifiers from @xds/* to @pharos-ds/*
 *
 * The v0.1.0 release moved the public package scope from @xds to
 * @pharos-ds. Consumers update dependencies first, install, then run
 * `pharos upgrade`; this transform only updates JS/TS module specifiers in
 * source code.
 */

export const meta = {
  title: 'Migrate module specifiers from @xds/* to @pharos-ds/*',
  description:
    ...
    '@xds/* to the @pharos-ds/* packages used by Pharos v0.1.0.',
  pr: '#3092',
...
// @pharos-ds/theme-neutral, whose exported theme binding is `neutralTheme`
...
//     -> import {neutralTheme as defaultTheme} from '@pharos-ds/theme-neutral'
...
// `@xds/*` path and stop intercepting the renamed `@pharos-ds/*` import.
