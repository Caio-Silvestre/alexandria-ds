 ...
 * @see https://github.com/Caio-Silvestre/alexandria-ds/issues/3679
 *
 ...
 * from an Pharos core source are rewritten. No import changes are needed.
 */
...
/** Import sources that provide the Pharos Table component. */
const TABLE_IMPORT_SOURCES = new Set([
  '@pharos-ds/core',
  '@pharos-ds/core/Table',
  '@xds/core',
  '@xds/core/Table',
]);
...
const TODO_COMMENT =
  ' TODO(pharos): tableProps is deprecated — merge these into direct props manually ';
