 ...
 * @see https://github.com/Caio-Silvestre/alexandria-ds/issues/2672
 *
...
/** Import sources that provide the Pharos Avatar/AvatarGroup components. */
const IMPORT_SOURCES = new Set([
  '@pharos-ds/core',
  '@pharos-ds/core/Avatar',
  '@pharos-ds/core/AvatarGroup',
  '@xds/core',
  '@xds/core/Avatar',
