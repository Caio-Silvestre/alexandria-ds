    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `pharos docs migration
pharos docs theme
pharos docs styling
pharos template --list --type block
pharos template AppShellTopNavWithSideNav --skeleton
pharos template PopoverSettingsPanel --skeleton
pharos component AppShell
pharos component SideNav
pharos component TopNav
pharos component CommandPalette
pharos component Button
pharos component TextInput`,
        },
        {
          type: 'prose',
        ...
        },
        {
          ...
          code: `pharos docs migration --dense
pharos component Button --json`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `import {Theme} from '@pharos-ds/core/theme';
...
@import "tailwindcss/utilities.css" layer(utilities);`,
        ...
        },
        {
          ...
          code: `@layer reset, tw-preflight, pharos-base, pharos-theme;
...
@layer tw-preflight {
  @tailwind base; /* layered: pharos-theme now wins over preflight */
}
@tailwind components;
...
@import "./legacy-reset.css" layer(reset);`,
        ...
        },
        {
          ...
          items: [
            ...
            'Remove or demote the app legacy reset. The design system ships its own :where() reset in the lowest layer, so any app reset belongs in that same reset layer and never in a layer above pharos-base.',
            ...
            'Set moduleResolution to bundler or node16 and newer so subpath imports like @pharos-ds/core/reset.css resolve.',
...
import {VStack} from '@pharos-ds/core/VStack';
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `We are migrating this existing Tailwind/shadcn app to Pharos incrementally.

First run:
- pharos docs migration --dense
- pharos docs theme --dense
- pharos docs styling --dense
- pharos template AppShellTopNavWithSideNav --skeleton

Then migrate one route or shell surface at a time. Keep business logic and routing intact. Replace shadcn/Radix/Tailwind primitives with Pharos components, remove hardcoded colors, verify light and dark mode, and take screenshots before moving to the next surface.`,
        },
      ],
    },
  ],
