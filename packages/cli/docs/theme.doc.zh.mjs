...
export const docsZh = {
  ...
  sections: [
    ...
    { section: 'Available Themes', title: '可用主题', content: [null, null, { type: 'prose', text: '已发布主题：neutral（推荐起点）、butter、chocolate、gothic（仅暗色）、matcha、stone、y2k。@pharos-ds/theme-{name} = 源码版（运行时注入）。@pharos-ds/theme-{name}/built = 优化版（配合 theme.css）。' }] },
    ...
    { section: 'Building Themes for Production', title: '生产构建', content: [{ type: 'prose', text: 'pharos theme build 将 defineTheme 编译为静态 CSS。输出 .css + .js（__built:true）+ .d.ts。' }, null, null, null, null] },
