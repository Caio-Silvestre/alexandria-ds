    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: 'Install @pharos-ds/cli and run `npx @pharos-ds/cli init --features agents` to set up your Pharos context. Read the generated file.',
        },
        {
          type: 'prose',
        ...
        },
        {
          ...
          code: `npx @pharos-ds/cli init --features agents --agent claude    # .claude/CLAUDE.md
npx @pharos-ds/cli init --features agents --agent cursor    # .cursorrules
npx @pharos-ds/cli init --features agents --agent codex     # AGENTS.md (Copilot, Codex, etc.)`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          style: 'ordered',
          items: [
            '`pharos template --list`: find a related page pattern to use as reference',
            '`pharos template <name> --skeleton`: study the layout structure',
            '`pharos component <Name>`: read props and examples for every component used',
          ],
        },
        {
          type: 'prose',
...
npx @pharos-ds/cli init --features agents --agent-docs-path ~/.cursor/rules/xds.mdc`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          lang: 'text',
          label: 'Paste this into your AI',
          code: `Before writing any Pharos code, check your knowledge:
...
If you don't know all three, run \`npx @pharos-ds/cli init --features agents\` to generate agent docs, then read the generated file.`,
        },
      ],
    },
    {
      title: 'The pharos Pattern',
      content: [
        {
          type: 'prose',
          text: 'AI agents frequently invoke the CLI with incorrect paths (e.g. node_modules/@pharos-ds/cli/bin/docs.mjs instead of pharos.mjs), leading to silent failures. Adding an npm script alias with the correct path eliminates this entirely.',
        },
        {
          type: 'code',
          lang: 'json',
  ...
  "pharos": "node node_modules/@pharos-ds/cli/bin/pharos.mjs"
        ...
        {
          type: 'prose',
          text: 'With this alias, agents use `pharos component --list` instead of guessing the binary path. The `--` separator is standard npm convention for passing flags to scripts.',
        },
        {
          type: 'code',
          lang: 'bash',
          label: 'Reliable CLI invocation',
          code: `pharos component --list
pharos component Dialog --dense
pharos docs styling --dense
pharos docs tokens --dense`,
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          code: `pharos component Dialog --dense
pharos docs styling --dense
pharos docs tokens --dense`,
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'prose',
          text: 'Pharos ships a Model Context Protocol (MCP) server that any MCP-compatible AI tool can connect to. Instead of manually pasting CLI output, the AI can query the Pharos design system directly, searching for components, reading full documentation, and pulling code examples on demand.',
        },
        {
          type: 'prose',
  ...
  "mcpServers": {
    "xds": {
      "type": "url",
      "url": "https://pharos-ds.vercel.app/mcp"
    }
  }
}`,
        },
