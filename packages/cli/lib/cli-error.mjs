...
/**
 * @file Pharos CLI — central error handling helper.
 *
 * ## Exit-code policy
 *
 * The Pharos CLI follows one rule above all: **exit code is the contract**. CI
 ...
 *      default (e.g. `pharos component` lists all components, `pharos docs` lists
