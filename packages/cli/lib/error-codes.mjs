...
/**
 * @file Pharos CLI — stable machine-readable error codes.
 *
 * ## Why codes exist
 *
 ...
 * command, the API layer (`PharosError`), or Commander's own parse machinery —
 ...
 *   throw new PharosError('No component named "Buton"', suggestions, ERROR_CODES.ERR_UNKNOWN_COMPONENT);
 *
...
/**
 * The complete, frozen set of Pharos CLI error codes. Append-only.
...
export const ERROR_CODES = Object.freeze({
  ...
  /** A top-level command name was not recognized (e.g. `pharos bogus`). */
  ERR_UNKNOWN_COMMAND: 'ERR_UNKNOWN_COMMAND',
  /** A subcommand under a command group was not recognized (e.g. `pharos theme bogus`). */
  ...
  /** `@pharos-ds/core` could not be located (not installed / not in a monorepo). */
  ...
  // ── Upgrade ──────────────────────────────────────────────────────
  /** The current `@pharos-ds/core` version could not be detected. */
