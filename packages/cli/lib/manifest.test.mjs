 ...
 *      are described once, and the bare `xds --json` / `pharos manifest --json`
...
describe('manifest: shape', () => {
  it('has top-level metadata', () => {
    expect(manifest.name).toBe('pharos');
