...
/**
 * @file Consumer utilities for parsing Pharos CLI JSON output.
 *
 * Exported via `@pharos-ds/cli/json`:
 *   import { parseResponse, isError, assertResponse } from '@pharos-ds/cli/json';
 */
