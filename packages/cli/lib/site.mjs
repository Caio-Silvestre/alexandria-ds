...
/**
 * @file site.mjs — the canonical Pharos site origin for CLI code.
 *
 * The published Pharos site is the single source of truth for docs, the blog,
...
export const SITE_URL = 'https://pharos-ds.vercel.app';
