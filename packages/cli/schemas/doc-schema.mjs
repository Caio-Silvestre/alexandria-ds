 ...
 * docs keep loading unchanged. Kept free of any `@pharos-ds/core` import so
 * the hot path that loads them (doc discovery, `pharos init`) does not require
 * core's built `dist/`. The authoring factories live in
 * `@pharos-ds/core/authoring` and are re-exported from `../doc.mjs` for the
 * public `@pharos-ds/cli/doc` surface.
 */
 ...
 * `@pharos-ds/core/docs-types`. Only `name`, `type`, and `description` are
