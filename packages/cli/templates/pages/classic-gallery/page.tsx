...
import {VStack, Layout, LayoutContent} from '@pharos-ds/core/Layout';
...
const GALLERY_IMAGES: GalleryImage[] = [
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-scene-horizontal-1.png',
    alt: 'Moody scene landscape',
    category: 'scene',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-lifestyle-vertical-1.png',
    alt: 'Moody lifestyle portrait',
    category: 'lifestyle',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-home-vertical-1.png',
    alt: 'Moody home interior',
    category: 'home',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-scene-horizontal-2.png',
    alt: 'Moody scene vista',
    category: 'scene',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-lifestyle-vertical-2.png',
    alt: 'Moody lifestyle scene',
    category: 'lifestyle',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-lifestyle-horizontal-1.png',
    alt: 'Moody lifestyle horizontal',
    category: 'lifestyle',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-scene-vertical-1.png',
    alt: 'Moody scene vertical',
    category: 'scene',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-home-vertical-2.png',
    alt: 'Moody home vertical',
    category: 'home',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-home-horizontal-1.png',
    alt: 'Moody home horizontal',
    category: 'home',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/moody-scene-vertical-2.png',
    alt: 'Moody scene vertical',
    category: 'scene',
  },
];
