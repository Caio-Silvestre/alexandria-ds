...
// @container grid (the sanctioned Pharos pattern for container-responsive layout).
// The container query lives in a plain <style> tag below so it needs NO CSS
// compiler. Image fill + radius are custom because Pharos has no image
// primitive (#2582).
...
const IMAGES: GalleryImage[] = [
  ...
  {
    src: 'https://pharos-ds.vercel.app/assets/light-home-horizontal-1.png',
    title: 'Making memories',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/light-lifestyle-horizontal-1.png',
    title: 'Being free',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/light-working-horizontal-2.png',
