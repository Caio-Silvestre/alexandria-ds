...
const ITEM_IMAGES: Record<string, {src: string}> = {
  '1': {src: 'https://pharos-ds.vercel.app/assets/light-product-1.png'},
  '2': {src: 'https://pharos-ds.vercel.app/assets/light-product-4.png'},
  '3': {src: 'https://pharos-ds.vercel.app/assets/light-product-5.png'},
};
...
// ── Styles ────────────────────────────────────────────────────────────────────
// Plain inline styles using Pharos design-token CSS variables (declared at
// :root by `@pharos-ds/core/pharos.css`). No StyleX compiler required.
