...
import {VStack, HStack, Layout, LayoutContent} from '@pharos-ds/core/Layout';
...
// Custom CSS here is limited to what Pharos components can't express today:
// - image fill + corner radius (no Image primitive — #2582)
// - the sticky info column (no sticky prop on Pharos layout primitives — #2613)
// Keeps the info column in view while the gallery scrolls. No sticky prop on
// Pharos layout primitives.
...
const IMAGES = [
  'https://pharos-ds.vercel.app/assets/light-product-1.png',
  'https://pharos-ds.vercel.app/assets/light-product-1.png',
  'https://pharos-ds.vercel.app/assets/light-product-2.png',
  'https://pharos-ds.vercel.app/assets/light-product-3.png',
  'https://pharos-ds.vercel.app/assets/light-product-4.png',
  'https://pharos-ds.vercel.app/assets/light-product-5.png',
  'https://pharos-ds.vercel.app/assets/light-product-3.png',
];
