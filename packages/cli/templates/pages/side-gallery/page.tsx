...
const IMAGES = [
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-lifestyle-vertical-3.png',
    alt: 'Colorful lifestyle scene',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-lifestyle-horizontal-1.png',
    alt: 'Colorful lifestyle horizontal',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-lifestyle-vertical-1.png',
    alt: 'Colorful lifestyle vertical',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-home-vertical-2.png',
    alt: 'Colorful home interior',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-home-vertical-3.png',
    alt: 'Colorful home scene',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-home-vertical-1.png',
    alt: 'Colorful home vertical',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-lifestyle-horizontal-2.png',
    alt: 'Colorful lifestyle wide',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-lifestyle-vertical-2.png',
    alt: 'Colorful lifestyle detail',
  },
  {
    src: 'https://pharos-ds.vercel.app/assets/colorful-lifestyle-vertical-4.png',
