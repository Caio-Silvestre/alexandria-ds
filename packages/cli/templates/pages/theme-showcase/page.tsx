...
import {useAppShellMobile} from '@pharos-ds/core/AppShell';
...
import {Table, proportional, pixel} from '@pharos-ds/core/Table';
...
import {TopNav, TopNavHeading, TopNavItem} from '@pharos-ds/core/TopNav';
import {
  ChatComposer,
  ChatMessage,
  ChatMessageBubble,
...
// Styles passed to Pharos components via their `style` prop. Pharos components
...
// Neutral product photos, served from the shared pharos asset CDN so the
// scaffolded template renders real imagery without needing local public assets.
const DEFAULT_IMAGES: Record<string, string> = {
  watch: 'https://pharos-ds.vercel.app/assets/Neutral-Watch.png',
  headphones:
    'https://pharos-ds.vercel.app/assets/Neutral-Headphones.png',
  backpack: 'https://pharos-ds.vercel.app/assets/Neutral-Backpack.png',
  wallet: 'https://pharos-ds.vercel.app/assets/Neutral-Wallet.png',
  tumbler: 'https://pharos-ds.vercel.app/assets/Neutral-Tumbler.png',
  throw_: 'https://pharos-ds.vercel.app/assets/Neutral-Blanket.png',
};
