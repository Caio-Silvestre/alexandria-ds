...
export interface ComponentListEntry {
  name: string;
  /** Owner package, e.g. '@pharos-ds/core' or '@acme/pharos-meta'. */
  package: string;
}
...
export interface ComponentOwnership {
  /** Owner package, e.g. '@pharos-ds/core' or an integration package name. */
  package: string;
  /** Import specifier for the component (e.g. '@pharos-ds/core/Button'). */
  import: string;
