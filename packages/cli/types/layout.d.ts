 ...
 *
 * `pharos layout expand|check|grammar` turn compressed XLE/XLO expressions into
 * validated XDS TSX (or echo canonical surfaces / a grammar cheatsheet).
 *
 * Invocation                                 -> type discriminator
 * -----------------------------------------------------------------
 * pharos --json layout expand "<expr>"       -> layout.expand
 * pharos --json layout check "<expr>"        -> layout.check
 * pharos --json layout grammar               -> layout.grammar
 */
...
/** pharos --json layout expand "<expr>" [path] */
