...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-app-shell', visualProps: ['variant']},
      {className: 'pharos-app-shell-header', visualProps: ['variant']},
      {className: 'pharos-app-shell-sidenav', visualProps: ['variant']},
    ],
  },
};
