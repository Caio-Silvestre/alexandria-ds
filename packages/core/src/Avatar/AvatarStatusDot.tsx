 ...
 * @example
 * ```
 * declare module '@pharos-ds/core/Avatar' {
 ...
 * `.pharos-avatar-status-dot[data-variant="..."]` (e.g. a `::before` mark).
 */
 ...
 * the `pharos-avatar-status-dot-glyph` class and its `data-shape`
 * attribute.
 *
