...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-banner', visualProps: ['container', 'status']},
      {className: 'pharos-banner-icon', visualProps: ['status']},
      {className: 'pharos-banner-content', visualProps: ['container', 'status']},
    ],
    vars: [
...
export const docsZh = {
  ...
  theming: {
    targets: [
      ...
      {
        className: 'pharos-banner-icon',
        visualProps: [
          'status',
        ],
      },
      {
        className: 'pharos-banner-content',
        visualProps: [
          'container',
          'status',
        ],
