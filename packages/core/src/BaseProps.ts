 ...
 * @output Exports BaseProps — the shared base interface for all Pharos components
...
/**
 * Base props shared by all Pharos components.
 *
...
> {
   ...
   * Pharos component prop/state reflection (for example data-variant/data-size). */
