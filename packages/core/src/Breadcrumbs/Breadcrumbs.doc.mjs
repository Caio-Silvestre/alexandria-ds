...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-breadcrumb-item'},
      {className: 'pharos-breadcrumb-item-menu-trigger'},
      {className: 'pharos-breadcrumb-menu'},
      {className: 'pharos-breadcrumbs', visualProps: ['variant']},
    ],
  },
