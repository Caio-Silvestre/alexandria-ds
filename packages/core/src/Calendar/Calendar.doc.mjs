...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-calendar', visualProps: ['mode']},
      {className: 'pharos-calendar-nav', visualProps: ['nav'], states: ['disabled']},
      {className: 'pharos-calendar-day', states: ['selected', 'today', 'disabled', 'in-range', 'marker']},
    ],
  },
};
...
export const docsZh = {
  ...
  theming: {
    targets: [
      {
        className: 'pharos-calendar',
        visualProps: [
          'mode',
        ],
      },
      {
        className: 'pharos-calendar-nav',
        visualProps: [
          'nav',
        ],
        states: [
