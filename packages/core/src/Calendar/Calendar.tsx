    ...
    (date: PlainDate) => {
      ...
      if (mode === 'single') {
        ...
        if (rangeSelectionStart === null) {
          ...
          announce(
            t('@pharos.calendar.rangeStartAnnounce', {
          ...
          announce(
            t('@pharos.calendar.rangeCompleteAnnounce', {
    ...
    <div
      ...
      <div {...stylex.props(calendarStyles.header)}>
        <Button
          ...
          label={t('@pharos.calendar.previousMonth')}
          variant="ghost"
          icon={
        ...
        <Button
          ...
          label={t('@pharos.calendar.nextMonth')}
          variant="ghost"
          icon={
            <span {...stylex.props(calendarStyles.navIcon, rtlStyles.mirror)}>
...
function DayCell({
  ...
  const dayLabel = state.isSelected
    ? t('@pharos.calendar.daySelected', {date: dateLabel})
    : state.isRangeStart && state.isRangeEnd
      ? isRangeSelectionInProgress
        ? t('@pharos.calendar.dayRangeStart', {date: dateLabel})
        : t('@pharos.calendar.dayRangeStartAndEnd', {date: dateLabel})
      : state.isRangeStart
        ? t('@pharos.calendar.dayRangeStart', {date: dateLabel})
        : state.isRangeEnd
          ? t('@pharos.calendar.dayRangeEnd', {date: dateLabel})
          : state.isInRange
            ? t('@pharos.calendar.dayInRange', {date: dateLabel})
            : dateLabel;
