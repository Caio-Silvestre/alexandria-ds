...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-chat-layout', visualProps: ['density']},
      {className: 'pharos-chat-composer', visualProps: ['density']},
      {className: 'pharos-chat-composer-input'},
      {className: 'pharos-chat-composer-drawer', visualProps: ['collapsed']},
      {className: 'pharos-chat-message', visualProps: ['sender', 'density']},
      {
        className: 'pharos-chat-message-bubble',
        visualProps: ['sender', 'variant', 'density'],
      },
      {className: 'pharos-chat-message-list', visualProps: ['density']},
      {className: 'pharos-chat-system-message', visualProps: ['variant']},
      {className: 'pharos-chat-message-metadata'},
      {className: 'pharos-chat-send-button'},
      {className: 'pharos-chat-tokenized-text'},
      {className: 'pharos-chat-tool-calls'},
      {className: 'pharos-trigger-menu'},
    ],
    vars: [
