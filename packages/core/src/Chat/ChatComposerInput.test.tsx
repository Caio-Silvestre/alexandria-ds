...
describe('ChatComposerInput', () => {
  ...
  describe('selection recovery (no range inside editable)', () => {
    ...
    it('paste inserts a token chip for long pastes after a focus() with no selection range', () => {
      ...
      expect(textbox.querySelector('[data-pharos-token]')).toBeInTheDocument();
    });
    ...
    it('paste falls through to plain-text path when pasteAsToken={false}', () => {
      ...
      expect(
        textbox.querySelector('[data-pharos-token]'),
  ...
  describe('refs', () => {
    it('forwards ref to the root element', () => {
      ...
      expect(root).toHaveClass('pharos-chat-composer-input');
    });
  ...
  describe('token backspace handling', () => {
    it('removes token and trailing NBSP on backspace', () => {
      ...
      const tokenSpan = textbox.querySelector('[data-pharos-token]');
      ...
      expect(textbox.querySelector('[data-pharos-token]')).toBeNull();
    });
  ...
  describe('pharos class names', () => {
    it('has pharos-chat-composer-input class', () => {
      const {container} = render(<ChatComposerInput />);
      expect(
        container.querySelector('.pharos-chat-composer-input'),
      ).toBeInTheDocument();
    });
  });
  ...
  describe('trigger menu cursor anchor', () => {
    ...
    const BODY_ANCHOR_SELECTOR = 'span[data-pharos-trigger-anchor]';
