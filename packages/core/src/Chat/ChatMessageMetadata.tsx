...
> = {
  sending: {icon: 'clock', i18nKey: '@pharos.chat.status.sending'},
  sent: {icon: 'check', i18nKey: '@pharos.chat.status.sent'},
  delivered: {icon: 'checkDouble', i18nKey: '@pharos.chat.status.delivered'},
  read: {icon: 'checkDouble', i18nKey: '@pharos.chat.status.read'},
  error: {icon: 'error', i18nKey: '@pharos.chat.status.failed'},
};
  ...
  return (
    <div
      ...
      {statusConfig != null && (
        <span
          title={statusLabel}
          aria-label={t('@pharos.chat.messageAriaLabel', {
