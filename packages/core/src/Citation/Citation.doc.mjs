...
export const docs = {
  ...
  usage: {
    ...
    anatomy: [
      ...
      },
      {
        ...
        required: false,
        description:
          'An optional source icon shown before the label text. Accepts a favicon/logo image URL (via source.src) or a React node such as an Pharos <Icon>. Only available in the label variant.',
      },
      {
        name: 'Label text',
        required: false,
  ...
  theming: {
    targets: [
      {className: 'pharos-citation', visualProps: ['variant']},
    ],
  },
};
