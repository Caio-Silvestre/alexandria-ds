...
describe('CodeBlock', () => {
  ...
  it('applies a per-instance syntax theme via the syntaxTheme prop', () => {
    ...
    const wrapper = container.querySelector('[data-pharos-syntax-theme]');
    expect(wrapper).not.toBeNull();
    expect(wrapper).toHaveAttribute('data-pharos-syntax-theme', 'dracula');
  ...
  it('renders no syntax theme wrapper when syntaxTheme is not set', () => {
    ...
    expect(container.querySelector('[data-pharos-syntax-theme]')).toBeNull();
