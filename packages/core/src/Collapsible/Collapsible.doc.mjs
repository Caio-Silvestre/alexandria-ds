...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-collapsible', visualProps: ['density']},
      {className: 'pharos-collapsible-trigger', visualProps: ['density']},
      {className: 'pharos-collapsible-content', visualProps: ['density']},
      {className: 'pharos-collapsible-group', visualProps: ['density']},
    ],
  },
