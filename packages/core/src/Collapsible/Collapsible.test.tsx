...
describe('Collapsible', () => {
  describe('structure and rendering', () => {
    ...
    it('renders the stable pharos-collapsible class on the root', () => {
      render(
        <Collapsible trigger="T" data-testid="root">
          c
        </Collapsible>,
      );
      expect(screen.getByTestId('root')).toHaveClass('pharos-collapsible');
    });

    it('renders the stable pharos-collapsible-trigger class on the trigger button', () => {
      render(<Collapsible trigger="T">c</Collapsible>);
      expect(screen.getByRole('button')).toHaveClass(
        'pharos-collapsible-trigger',
      );
    });

    it('renders the stable pharos-collapsible-content class on the content area', () => {
      render(<Collapsible trigger="T">c</Collapsible>);
      const content = contentFor(screen.getByRole('button'));
      expect(content).toHaveClass('pharos-collapsible-content');
    });
