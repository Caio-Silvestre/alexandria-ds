...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-command-palette-empty'},
      {className: 'pharos-command-palette-footer'},
      {className: 'pharos-command-palette-group'},
      {className: 'pharos-command-palette-group-heading'},
      {className: 'pharos-command-palette-input'},
      {className: 'pharos-command-palette-item'},
      {className: 'pharos-command-palette-list'},
    ],
  },
  usage: {
