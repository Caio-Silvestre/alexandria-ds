...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-date-input', visualProps: ['size', 'status']},
      {className: 'pharos-date-input-toggle-icon', states: ['state']},
      {className: 'pharos-date-input-clear-icon'},
    ],
  },
  usage: {
    description:
