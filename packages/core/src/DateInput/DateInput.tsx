...
export function DateInput({
  ...
  const placeholder =
    placeholderFromProps ?? t('@pharos.dateInput.placeholder');
  ...
  const popover = usePopover({
    dialogLabel: t('@pharos.dateInput.dialogLabel'),
    closeButtonLabel: t('@pharos.dateInput.closeCalendar'),
  ...
  const inputWrapper = (
    <div
      ...
      <button
        ...
        aria-label={
          popover.isOpen
            ? t('@pharos.dateInput.toggleCalendarClose')
            : t('@pharos.dateInput.openCalendar')
        }
        {...stylex.props(
          styles.iconButton,
        ...
        <Icon
          ...
          // state — via `defineTheme`. Same-element rules in @layer pharos-theme
      ...
      {hasClear && value !== undefined && !isEffectivelyDisabled && (
        <button
          type="button"
          onClick={handleClear}
          aria-label={t('@pharos.dateInput.clear', {label})}
          ...
          <Icon
            ...
            // Same-element rules in @layer pharos-theme win over the icon's own
