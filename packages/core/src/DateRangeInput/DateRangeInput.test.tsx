...
describe('DateRangeInput icon theme targets', () => {
  ...
  // Resolve a glyph span (the pharos-icon element) inside a given button,
  ...
  it('renders pharos-date-range-input-clear-icon on the clear glyph', () => {
    render(
      <DateRangeInput
        label="Range"
        value={RANGE}
    ...
    expect(icon).toHaveClass('pharos-date-range-input-clear-icon');
    expect(icon).toHaveClass('pharos-icon');
  });

  it('renders pharos-date-range-input-toggle-icon on the calendar-toggle glyph, reflecting state', () => {
    render(<DateRangeInput label="Range" value={null} onChange={() => {}} />);
    const icon = iconIn(getButton('Open calendar'));
    expect(icon).toHaveClass('pharos-date-range-input-toggle-icon');
    expect(icon).toHaveClass('pharos-icon');
  ...
  it('renders the default icons (secondary color, sm size) byte-identically', () => {
    ...
    const styleClasses = (el: HTMLElement) =>
      el.className
        ...
        .filter(
          c =>
            c !== 'pharos-date-range-input-clear-icon' &&
            c !== 'pharos-date-range-input-toggle-icon',
        )
        .sort();
  ...
  it('exposes the icon targets so a theme reaches icon color, size, and hover', () => {
    ...
    expect(css).toContain('.pharos-date-range-input-clear-icon');
    expect(css).toContain('.pharos-date-range-input-toggle-icon');
