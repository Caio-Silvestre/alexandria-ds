...
export function DateRangeInput({
  ...
  const placeholder =
    placeholderFromProps ?? t('@pharos.dateRangeInput.placeholder');
  ...
  const popover = usePopover({
    dialogLabel: t('@pharos.dateRangeInput.dialogLabel'),
      ...
      {popover.render(
        <div {...stylex.props(styles.popoverLayout)}>
          {presets && presets.length > 0 && (
            <div
              role="group"
              aria-label={t('@pharos.dateRangeInput.presetDateRanges')}
