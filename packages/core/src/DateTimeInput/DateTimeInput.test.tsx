...
describe('DateTimeInput', () => {
  ...
  describe('segment theme targets', () => {
    // The root only publishes `pharos-date-time-input`; the date and time
    ...
    it('renders the date segment target on the date wrapper', () => {
      ...
      const wrapper = screen
        ...
        .closest('.pharos-date-time-input-date-segment');
    ...
    it('renders the time segment target on the time wrapper', () => {
      ...
      const wrapper = screen
        ...
        .closest('.pharos-date-time-input-time-segment');
    ...
    it('keeps the root target intact', () => {
      ...
      expect(container.querySelector('.pharos-date-time-input')).not.toBeNull();
    });
    ...
    it('exposes both segments as themeable defineTheme targets', () => {
      ...
      expect(css).toContain('.pharos-date-time-input-date-segment {');
      expect(css).toContain('.pharos-date-time-input-date-segment.lg');
      expect(css).toContain('.pharos-date-time-input-time-segment {');
