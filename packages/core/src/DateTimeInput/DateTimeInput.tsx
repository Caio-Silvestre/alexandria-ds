...
export function DateTimeInput({
  ...
  const placeholder =
    placeholderFromProps ?? t('@pharos.dateTimeInput.placeholder');
  const timePlaceholder =
    timePlaceholderFromProps ?? t('@pharos.dateTimeInput.timePlaceholder');
  ...
  const popover = usePopover({
    dialogLabel: t('@pharos.dateTimeInput.dialogLabel'),
      ...
      <div
        ...
        <div
          ...
          <input
            ...
            readOnly={showsDisabledMessage || undefined}
            aria-label={
              timeLabel ?? t('@pharos.dateTimeInput.timeSuffix', {label})
            }
            aria-describedby={ariaDescribedBy}
            aria-required={isRequired === true ? 'true' : undefined}
            aria-invalid={
