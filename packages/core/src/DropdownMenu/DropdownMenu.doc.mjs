...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-dropdown-menu'},
      {className: 'pharos-dropdown-menu-item', visualProps: ['size']},
      {
        className: 'pharos-dropdown-menu-checkbox',
        visualProps: ['size'],
        states: ['checked', 'disabled'],
      },
      {
        className: 'pharos-dropdown-menu-radio',
        visualProps: ['size'],
        states: ['checked', 'disabled'],
      },
    ],
