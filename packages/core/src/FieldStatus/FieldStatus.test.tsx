...
function assertiveRegion(): HTMLElement | null {
  return document.querySelector('[data-pharos-live-region="assertive"]');
}
...
describe('FieldStatus', () => {
  ...
  describe('theme class + data attribute reflection', () => {
    it('renders the stable pharos-field-status class', () => {
      render(<FieldStatus type="error" message="msg" data-testid="fs" />);
      expect(screen.getByTestId('fs')).toHaveClass('pharos-field-status');
    });
  ...
  describe('prop forwarding', () => {
    ...
    it('merges a consumer className with the stable class', () => {
      ...
      expect(el).toHaveClass('pharos-field-status');
    });
