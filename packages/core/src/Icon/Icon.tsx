...
const spanSizeStyles = stylex.create({
  /* eslint-disable @pharos-ds/no-hardcoded-styles -- fontSize here sizes 1em-based
...
> {
   ...
   * color/size styles for optimal deduplication, matching how other Pharos
...
function IconFromRegistry({
  ...
  // The styling props (className, style, xstyle) are handled here so they
  // COMPOSE with the internal pharos-icon + StyleX classes/styles instead of
