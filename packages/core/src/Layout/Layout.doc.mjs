...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-layout', visualProps: ['height']},
      {className: 'pharos-layout-content'},
      {className: 'pharos-layout-footer'},
      {className: 'pharos-layout-header'},
      {className: 'pharos-layout-panel'},
    ],
  },
