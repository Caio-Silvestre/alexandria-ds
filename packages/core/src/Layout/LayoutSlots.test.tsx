...
describe('LayoutHeader', () => {
  ...
  it('carries the pharos-layout-header class', () => {
    const {container} = render(<LayoutHeader>H</LayoutHeader>);
    expect(
      container.querySelector('.pharos-layout-header'),
    ).toBeInTheDocument();
  });
  ...
  it('omits data-divider by default', () => {
    ...
    expect(
      container
        .querySelector('.pharos-layout-header')
  ...
  it('applies a numeric height to the element style', () => {
    ...
    const el = container.querySelector('.pharos-layout-header') as HTMLElement;
  ...
  it('forwards ref to the outer element', () => {
    ...
    expect(ref.current?.className).toContain('pharos-layout-header');
  });
...
describe('LayoutFooter', () => {
  ...
  it('carries the pharos-layout-footer class', () => {
    const {container} = render(<LayoutFooter>F</LayoutFooter>);
    expect(
      container.querySelector('.pharos-layout-footer'),
    ).toBeInTheDocument();
  });
  ...
  it('omits data-divider by default and reflects hasDivider when set', () => {
    ...
    const sel = '.pharos-layout-footer';
  ...
  it('inherits the divider default from context', () => {
    ...
    expect(
      container
        .querySelector('.pharos-layout-footer')
        ?.getAttribute('data-divider'),
    ).toBe('true');
  });
  ...
  it('forwards ref to the outer element', () => {
    ...
    expect(ref.current).toBeInstanceOf(HTMLDivElement);
    expect(ref.current?.className).toContain('pharos-layout-footer');
  });
});
...
describe('LayoutContent', () => {
  ...
  it('carries the pharos-layout-content class', () => {
    const {container} = render(<LayoutContent>C</LayoutContent>);
    expect(
      container.querySelector('.pharos-layout-content'),
    ).toBeInTheDocument();
  });
  ...
  it('forwards ref to the element', () => {
    ...
    expect(ref.current).toBeInstanceOf(HTMLDivElement);
    expect(ref.current?.className).toContain('pharos-layout-content');
  });
  ...
  it('merges caller className and inline style', () => {
    ...
    const el = container.querySelector('.pharos-layout-content') as HTMLElement;
...
describe('LayoutPanel', () => {
  ...
  it('carries the pharos-layout-panel class', () => {
    const {container} = render(<LayoutPanel>P</LayoutPanel>);
    expect(container.querySelector('.pharos-layout-panel')).toBeInTheDocument();
  });
  ...
  it('applies a numeric width to the element style', () => {
    ...
    const el = container.querySelector('.pharos-layout-panel') as HTMLElement;
  ...
  it('forwards ref to the element', () => {
    ...
    expect(ref.current).toBeInstanceOf(HTMLDivElement);
    expect(ref.current?.className).toContain('pharos-layout-panel');
  });
