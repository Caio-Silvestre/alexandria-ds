...
/**
 * Propagation styles for --pharos-section-padding.
...
export const sectionPaddingPropagationStyles = stylex.create({
  0: {'--pharos-section-padding': spacingVars['--spacing-0']},
  0.5: {'--pharos-section-padding': spacingVars['--spacing-0-5']},
  1: {'--pharos-section-padding': spacingVars['--spacing-1']},
  1.5: {'--pharos-section-padding': spacingVars['--spacing-1-5']},
  2: {'--pharos-section-padding': spacingVars['--spacing-2']},
  3: {'--pharos-section-padding': spacingVars['--spacing-3']},
  4: {'--pharos-section-padding': spacingVars['--spacing-4']},
  5: {'--pharos-section-padding': spacingVars['--spacing-5']},
  6: {'--pharos-section-padding': spacingVars['--spacing-6']},
  8: {'--pharos-section-padding': spacingVars['--spacing-8']},
  10: {'--pharos-section-padding': spacingVars['--spacing-10']},
});
