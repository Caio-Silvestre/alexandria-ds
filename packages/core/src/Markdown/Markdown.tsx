 ...
 * @position Core implementation; renders markdown as Pharos components
 */
      ...
      if (isTaskList) {
        ...
        return (
          <div
            ...
            <CheckboxList
              label={t('@pharos.markdown.taskList')}
              isLabelHidden
              value={checkedValues}
    ...
    case 'table': {
      ...
      return (
        <div
          ...
          tabIndex={0}
          role="group"
          aria-label={t('@pharos.markdown.table')}
          {...stylex.props(
            styles.tableWrapper,
            spacing,
            contentWidthValue != null
...
/**
 * Renders a markdown string as Pharos components. Supports streaming with
