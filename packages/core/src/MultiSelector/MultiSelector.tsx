...
export function MultiSelector<T extends MultiSelectorOptionType>({
  ...
  const placeholder =
    placeholderFromProps ?? t('@pharos.multiSelector.selectPlaceholder');
  const selectAllLabel =
    selectAllLabelFromProps ?? t('@pharos.multiSelector.selectAll');
  const searchPlaceholder =
    searchPlaceholderFromProps ?? t('@pharos.multiSelector.searchPlaceholder');
    ...
    return (
      <div {...stylex.props(styles.searchWrapper)}>
        <input
          ...
          aria-label={t('@pharos.multiSelector.searchOptions')}
          type="text"
          value={searchQuery}
      ...
      <div
        ...
        {hasClear && value.length > 0 && !isDisabled && (
          <button
            type="button"
            onClick={handleClear}
            aria-label={t('@pharos.multiSelector.clearAll', {label})}
            ...
            <Icon
              ...
              // Same-element rules in @layer pharos-theme win over the icon's
        ...
        <span
          ...
          {status ? (
            ...
            <Icon
              ...
              // @layer pharos-theme win over the icon's own base color/size,
