...
export const docs = {
  ...
  props: [
    ...
    },
    {
      name: 'startIcon',
      type: 'IconType',
      description: 'Icon to display at the start of the input. See `pharos docs icons` for valid semantic names.',
    },
    {
      name: 'labelIcon',
      type: 'IconType',
  ...
  theming: {
    targets: [
      {className: 'pharos-number-input', visualProps: ['size', 'status']},
    ],
  },
  usage: {
    description:
