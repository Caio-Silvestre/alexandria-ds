...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-outline', visualProps: ['density']},
      {className: 'pharos-outline-indicator'},
      {className: 'pharos-outline-item', visualProps: ['level'], states: ['active']},
    ],
  },
  components: [
    {
...
`,
        },
        {
          ...
          code: `
import {Outline, useOutlineFromMarkdown} from '@pharos-ds/core/Outline';
