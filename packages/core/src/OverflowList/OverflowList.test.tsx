...
describe('OverflowList', () => {
  ...
  describe('rendering contract', () => {
    it('renders the stable pharos-overflow-list class on the visible container', () => {
      render(
      ...
      expect(visibleContainer()).toHaveClass('pharos-overflow-list');
    });
    ...
    it('forwards a ref to the visible container', () => {
      ...
      expect(el).toHaveClass('pharos-overflow-list');
    });
