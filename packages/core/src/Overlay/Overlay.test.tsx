...
describe('Overlay', () => {
  describe('rendering & structure', () => {
    ...
    it('renders a root div carrying the pharos-overlay class', () => {
      ...
      expect(root.className).toContain('pharos-overlay');
    });
    ...
    it('applies the pharos-overlay-scrim class to the scrim', () => {
      const {container} = render(
        <Overlay content={<span>c</span>}>
          <div>b</div>
        </Overlay>,
      );
      expect(getScrim(container).className).toContain('pharos-overlay-scrim');
    });
  });
  ...
  describe('scrim mode → media theme inversion', () => {
    it('dark scrim (default) wraps content in a dark MediaTheme', () => {
      ...
      expect(
        container.querySelector('[data-pharos-media="dark"]'),
      ).toBeInTheDocument();
    });
    ...
    it('light scrim wraps content in a light MediaTheme', () => {
      ...
      expect(
        container.querySelector('[data-pharos-media="light"]'),
      ).toBeInTheDocument();
      expect(
        container.querySelector('[data-pharos-media="dark"]'),
    ...
    it('scrim={false} renders no MediaTheme wrapper', () => {
      ...
      expect(
        container.querySelector('[data-pharos-media]'),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe('styling & ref', () => {
    it('forwards ref to the root div element', () => {
      ...
      expect(ref.current?.className).toContain('pharos-overlay');
    });
