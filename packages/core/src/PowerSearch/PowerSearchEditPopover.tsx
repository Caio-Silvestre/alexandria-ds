  ...
  return (
    <HStack gap={2} vAlign="center">
      <div {...stylex.props(styles.nestedFieldSelector)}>
        <Selector
          label={t('@pharos.powersearch.editor.field')}
          isLabelHidden
      ...
      {operatorOptions.length > 0 && (
        <div {...stylex.props(styles.nestedOperatorSelector)}>
          <Selector
            label={t('@pharos.powersearch.editor.operator')}
            isLabelHidden
      ...
      if (isNested) {
        ...
        if (!isReadOnly) {
          children.push({
            ...
            label: (
              <Button
                label={t('@pharos.powersearch.editor.addFilter')}
        ...
        return {
          ...
          endContent: !isReadOnly ? (
            <Button
              label={t('@pharos.powersearch.editor.removeFilter')}
    ...
    <div {...stylex.props(styles.nestedRootLabel)}>
      {operatorOptions.length > 1 ? (
        <div {...stylex.props(styles.operatorSelector)}>
          <Selector
            label={t('@pharos.powersearch.editor.groupOperator')}
            isLabelHidden
            options={operatorOptions}
        ...
        (operatorOptions[0]?.label ?? t('@pharos.powersearch.editor.group'))
      )}
    </div>
  );
...
export function PowerSearchEditPopover({
  ...
  const saveButtonLabel =
    saveButtonLabelFromProps ?? t('@pharos.powersearch.editor.apply');
        ...
        <div {...stylex.props(styles.footer)}>
          <HStack gap={2} hAlign="between">
            {!isReadOnly && mode === 'edit' ? (
              <Button
                label={t('@pharos.powersearch.editor.delete')}
            ...
            <HStack gap={2}>
              <Button
                label={t('@pharos.powersearch.editor.cancel')}
                onClick={onCancel}
                variant="ghost"
                size="sm"
              />
