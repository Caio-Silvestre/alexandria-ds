...
function StringEditor({
  ...
  if (operatorValue.searchSource) {
    ...
    return (
      <Typeahead
        label={t('@pharos.powersearch.valueEditor.value')}
        isLabelHidden
        ...
        placeholder={t('@pharos.powersearch.valueEditor.searchPlaceholder')}
        debounceMs={150}
      />
    );
  }
  ...
  return (
    <TextInput
      ...
      isLabelHidden
      value={currentValue}
      placeholder={t('@pharos.powersearch.valueEditor.enterValuePlaceholder')}
...
function StringListEditor({
  ...
  return (
    <Tokenizer
      label={t('@pharos.powersearch.valueEditor.values')}
      isLabelHidden
      searchSource={source}
      value={currentValue}
      onChange={items => {
      ...
      placeholder={t('@pharos.powersearch.valueEditor.addValuesPlaceholder')}
...
function IntegerEditor({
  ...
  return (
    <NumberInput
      ...
      isIntegerOnly
      placeholder={t('@pharos.powersearch.valueEditor.enterNumberPlaceholder')}
    />
  );
}
...
function TimeEditor({
  ...
  return (
    <TimeInput
      label={t('@pharos.powersearch.valueEditor.time')}
      isLabelHidden
      value={currentValue}
      onChange={value => {
        if (value != null) {
...
function DateAbsoluteEditor({
  ...
  return (
    <DateInput
      label={t('@pharos.powersearch.valueEditor.date')}
      isLabelHidden
      value={currentValue}
      onChange={value => {
        if (value != null) {
...
function DateRelativeEditor({
  ...
  return (
    <Selector
      label={t('@pharos.powersearch.valueEditor.relativeDate')}
      isLabelHidden
      options={options}
      value={currentValue}
      onChange={value => {
...
function DateRangeEditor({
  ...
  return (
    <>
      <DateInput
        label={t('@pharos.powersearch.valueEditor.startDate')}
        isLabelHidden
        value={startValue}
        onChange={handleStartChange}
      />
      <DateInput
        label={t('@pharos.powersearch.valueEditor.endDate')}
        isLabelHidden
        value={endValue}
...
function EnumListEditor({
  ...
  return (
    <Tokenizer
      ...
      placeholder={t('@pharos.powersearch.valueEditor.selectValuesPlaceholder')}
      hasEntriesOnFocus
      debounceMs={0}
    />
  );
...
function EntityListEditor({
  ...
  return (
    <Tokenizer
      label={t('@pharos.powersearch.valueEditor.entities')}
      isLabelHidden
      searchSource={source}
      value={currentValue}
      onChange={items => {
