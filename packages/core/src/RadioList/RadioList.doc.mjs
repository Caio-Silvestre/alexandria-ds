...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-radio-list', visualProps: ['orientation', 'size']},
      {className: 'pharos-radio-list-item'},
      {className: 'pharos-radio', visualProps: ['size'], states: ['checked', 'disabled']},
      {className: 'pharos-radio-dot', visualProps: ['size']},
    ],
  },
