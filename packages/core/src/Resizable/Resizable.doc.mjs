...
export const docs = {
    ...
    bestPractices: [
      {
        guidance: true,
        description:
          'Use useResizable() with existing Pharos layout components. ' +
  ...
  theming: {
    targets: [
      {className: 'pharos-resize-handle', visualProps: ['direction']},
      {className: 'pharos-resize-handle-pill'},
    ],
  },
  components: [
    {
...
export const docsDense = {
  ...
  usage: {
    ...
    bestPractices: [
      {guidance: true, description: 'Use useResizable() w/ existing Pharos layout components. Pass returned props to resizable prop on LayoutPanel or SideNav.'},
