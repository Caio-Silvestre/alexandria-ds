...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-selector', visualProps: ['size', 'status']},
      {className: 'pharos-selector-option'},
      {className: 'pharos-selector-clear-icon'},
      {className: 'pharos-selector-indicator-icon', states: ['state']},
    ],
  },
