...
export function Selector<T extends SelectorOptionType>(
  ...
  const placeholder = placeholderFromProps ?? t('@pharos.selector.placeholder');
  const searchPlaceholder =
    searchPlaceholderFromProps ?? t('@pharos.selector.searchPlaceholder');
    ...
    return (
      <div {...stylex.props(styles.searchWrapper)}>
        <input
          ...
          aria-label={t('@pharos.selector.searchOptions')}
          type="text"
          value={searchQuery}
      ...
      <div
        ...
        {hasClear && value != null && !isDisabled && (
          <button
            type="button"
            onClick={handleClear}
            aria-label={t('@pharos.selector.clearLabel', {label})}
