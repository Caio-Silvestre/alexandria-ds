...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-side-nav', visualProps: ['mode']},
      {className: 'pharos-side-nav-heading'},
      {className: 'pharos-side-nav-item', visualProps: ['size'], states: ['selected']},
      {className: 'pharos-side-nav-section'},
    ],
  },
