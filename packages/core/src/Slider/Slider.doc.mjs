...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-slider', visualProps: ['orientation'], states: ['disabled']},
      {className: 'pharos-slider-track', visualProps: ['orientation']},
      {className: 'pharos-slider-thumb', visualProps: ['orientation'], states: ['disabled']},
    ],
  },
  usage: {
    description:
