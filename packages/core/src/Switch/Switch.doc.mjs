...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'IconType',
      description:
        'Icon displayed before the label text. See `pharos docs icons` for valid semantic names.',
    },
    {
      name: 'labelTooltip',
      type: 'string',
  ...
  theming: {
    targets: [
      {
        className: 'pharos-switch',
        visualProps: ['size'],
        states: ['checked', 'disabled'],
      },
      {
        className: 'pharos-switch-thumb',
        visualProps: ['size'],
        states: ['checked'],
      },
      {
        className: 'pharos-switch-field',
