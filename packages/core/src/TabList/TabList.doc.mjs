...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-tab-list', visualProps: ['size']},
      {className: 'pharos-tab', states: ['selected']},
      {className: 'pharos-tab-indicator', states: ['selected']},
      {className: 'pharos-tab-menu'},
      {className: 'pharos-tab-menu-dropdown'},
      {className: 'pharos-tab-menu-item'},
    ],
  },
