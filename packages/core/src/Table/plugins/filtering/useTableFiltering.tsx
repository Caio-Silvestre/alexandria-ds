 ...
 * @input React, types, Pharos components, theme tokens
...
function TextFilterControl({
  ...
  return (
    <TextInput
      label={t('@pharos.tableFiltering.filterByColumn', {header})}
      isLabelHidden
      value={strValue}
      ...
      placeholder={t('@pharos.tableFiltering.filterByColumn', {header})}
      size={size}
      hasClear={hasClear}
    />
  );
  ...
  if (hasClear) {
    return (
      <Selector
        ...
        value={strValue || null}
        onChange={handleChange}
        placeholder={t('@pharos.table.filter.allPlaceholder')}
        size={size}
        hasClear
      />
    );
...
function PopoverFilterTrigger({
  ...
  return (
    <Popover
        ...
        <FilterStoreContext value={draftStore}>
          <div {...stylex.props(filterStyles.popoverContent)}>
            ...
            <div {...stylex.props(filterStyles.popoverActions)}>
              <Button
                label={t('@pharos.table.filter.reset')}
                variant="ghost"
                size="sm"
                onClick={handleClear}
              />
              ...
              <Button
                label={t('@pharos.table.filter.apply')}
                variant="primary"
                size="sm"
                onClick={handleApply}
              />
      ...
      <button
        type="button"
        aria-label={t('@pharos.tableFiltering.filterByColumn', {header})}
