...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'IconType',
      description:
        'Icon component rendered inside the leading edge of the textarea wrapper. See `pharos docs icons` for valid semantic names.',
    },
    {
      name: 'hasSpellCheck',
      type: 'boolean',
  ...
  theming: {
    targets: [
      {className: 'pharos-textarea', visualProps: ['size', 'status']},
    ],
  },
  usage: {
    description:
