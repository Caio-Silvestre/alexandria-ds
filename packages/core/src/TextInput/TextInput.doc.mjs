...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'IconType',
      description:
        'SVG icon component displayed at the start of the input. See `pharos docs icons` for valid semantic names.',
    },
    {
      name: 'status',
  ...
  theming: {
    targets: [
      {className: 'pharos-text-input', visualProps: ['size', 'status']},
    ],
  },
  usage: {
    description:
