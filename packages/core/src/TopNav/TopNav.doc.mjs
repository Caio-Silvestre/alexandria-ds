...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-top-nav', states: ['mode']},
      {className: 'pharos-top-nav-item', states: ['mode', 'selected']},
      {className: 'pharos-top-nav-heading'},
      {className: 'pharos-top-nav-mega-menu', states: ['mode']},
      {className: 'pharos-top-nav-mega-menu-item', states: ['mode']},
      {className: 'pharos-top-nav-mega-menu-featured-card'},
      {className: 'pharos-top-nav-menu'},
    ],
  },
