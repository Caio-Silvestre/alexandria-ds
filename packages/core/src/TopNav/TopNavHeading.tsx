...
export function TopNavHeading({
  ...
  const popover = usePopover({
    dialogLabel: t('@pharos.topNav.heading.dialogLabel'),
      ...
      <>
        <div
          ...
          {renderTextContent(
            <button
              type="button"
              aria-label={t('@pharos.topNav.heading.openMenu')}
              onClick={e => {
                e.stopPropagation();
        ...
        {popover.render(
          <div
            ...
            <div
              role="menu"
              aria-label={heading ?? t('@pharos.topNav.heading.dialogLabel')}>
