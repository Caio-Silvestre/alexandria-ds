...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-tree-list', visualProps: ['density']},
      {className: 'pharos-tree-list-item', visualProps: ['density'], states: ['selected', 'disabled']},
      {className: 'pharos-tree-list-chevron', states: ['state']},
      {className: 'pharos-tree-list-item-label', states: ['selected']},
      {className: 'pharos-tree-list-guide'},
    ],
    vars: [
