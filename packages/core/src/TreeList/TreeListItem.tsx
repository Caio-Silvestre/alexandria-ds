...
const styles = stylex.create({
  ...
  contentWrapper: {
    ...
    // `@layer pharos-base` and the theme layer can override it in normal
    ...
    <>
      <span
        ...
        {...mergeProps(
          ...
          // adds an `pharos-tree-list-item-label` class and reflects the row's
  ...
  const chevron = hasChildren ? (
    handleToggle != null ? (
      ...
      <button
        ...
        aria-label={t('@pharos.treeList.toggleChildren')}
        ...
        {...mergeProps(
          ...
          // `pharos-tree-list-chevron` class and reflects the open/closed state so
