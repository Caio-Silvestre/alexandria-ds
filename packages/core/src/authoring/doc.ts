 ...
 *   these authoring factories live in `@pharos-ds/core`.
 *
 ...
 */
export interface PharosBaseDocInput {
...
export interface PharosPropInput {
  name: string;
  type: string;
  description: string;
  default?: string;
...
export interface PharosParamInput {
  name: string;
  type: string;
  description: string;
  default?: string;
...
export interface PharosReturnInput {
  name: string;
  type: string;
  description: string;
  [key: string]: unknown;
 ...
 */
export interface PharosComponentDocInput extends PharosBaseDocInput {
  /** All public props for the component. */
  props: PharosPropInput[];
 ...
 */
export type PharosGenericDocInput = PharosBaseDocInput;
 ...
 */
export type PharosComponentDoc =
  PharosComponentDocInput | PharosFunctionDocInput | PharosGenericDocInput;
 ...
 */
export function createComponentDoc<T extends PharosComponentDocInput>(
  def: T,
): T & {type: 'component'} {
 ...
 * CLI load boundary.
 */
export function createFunctionDoc<T extends PharosFunctionDocInput>(
  def: T,
): T & {type: 'function'} {
 ...
 */
export function createDoc<T extends PharosGenericDocInput>(
  def: T,
): T & {type: 'generic'} {
