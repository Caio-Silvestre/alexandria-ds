...
export const docsDense = {
  description:
    'Returns StyleX style for animating element on mount. Only animates when element dynamically inserted after initial page paint; elements rendered on page load not animated. Uses Pharos motion tokens (duration, easing) for consistent timing. Requires "use client"; does not support SSR.',
  paramDescriptions: {
