...
describe('Theme', () => {
  beforeEach(() => {
    ...
    document.documentElement.removeAttribute('data-pharos-theme');
  });
  ...
  it('sets data-pharos-theme on wrapper div', () => {
    const {container} = render(
      <Theme theme={testTheme}>
        <span>child</span>
      </Theme>,
    );
    const wrapper = container.querySelector('[data-pharos-theme="test"]');
  ...
  // =========================================================================
  // Root detection — data-pharos-theme on <html>
  // =========================================================================

  it('syncs data-pharos-theme to <html> for root provider', () => {
    render(
      <Theme theme={testTheme} mode="light">
        <span>child</span>
      </Theme>,
    );
    expect(document.documentElement.getAttribute('data-pharos-theme')).toBe(
      'test',
    );
  });

  it('removes data-pharos-theme from <html> when root provider unmounts', () => {
    const {unmount} = render(
      <Theme theme={testTheme} mode="light">
        <span>child</span>
      </Theme>,
    ...
    unmount();
    expect(document.documentElement.hasAttribute('data-pharos-theme')).toBe(false);
  });
  ...
  it('does not let nested Theme override <html> data-pharos-theme', () => {
    render(
      <Theme theme={testTheme} mode="dark">
  ...
  it('nested Theme still sets data-theme on its own wrapper div', () => {
    ...
    const nestedWrapper = container.querySelector('[data-pharos-theme="alt"]');
