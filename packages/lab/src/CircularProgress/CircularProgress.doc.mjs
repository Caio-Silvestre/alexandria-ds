...
export const docs = {
  ...
  theming: {
    targets: [
      {className: 'pharos-circular-progress', visualProps: ['variant', 'size']},
      {className: 'pharos-circular-progress-track'},
      {className: 'pharos-circular-progress-fill', visualProps: ['variant']},
    ],
  },
  usage: {
    description:
