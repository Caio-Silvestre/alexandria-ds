...
/**
 * @file InfoTip.tsx
 * @input Uses React, stylex, Tooltip + Icon from @pharos-ds/core, color/spacing/radius/duration/ease tokens
 * @output Exports InfoTip component, InfoTipProps, InfoTipSize types
 * @position Lab experiment (RFC facebook/pharos#3349); core implementation consumed by index.ts
 *
...
import {Icon, type IconSize} from '@pharos-ds/core/Icon';
