 ...
 *   re-exported from @pharos-ds/lab. Tested by RichTextEditor.test.tsx.
 *
 ...
 *
 * NOTE: This is an EXPERIMENTAL component in @pharos-ds/lab (published only under
 * the `@canary` dist-tag, never as stable `latest`). It is the initial landing for the
 * OSS Lexical editor RFC; the goal is graduation to @pharos-ds/core after the
...
import {
  ...
  typographyVars,
  typeScaleVars,
} from '@pharos-ds/core/theme/tokens.stylex';
...
} from '@pharos-ds/core/Field';
import type {BaseProps} from '@pharos-ds/core';
import {VisuallyHidden} from '@pharos-ds/core/VisuallyHidden';
import type {SizeValue} from '@pharos-ds/core/utils';
import {useSize} from '@pharos-ds/core/SizeContext';
import {themeProps} from '@pharos-ds/core/utils';
...
> {
   ...
   * @default 'pharos-editor'
   */
  namespace?: string;
}

/**
 * A WYSIWYG rich-text editor built on Lexical, styled with Pharos design
 * tokens. Experimental — ships from `@pharos-ds/lab` (canary). `lexical` and
 ...
 * @example
 * ```
 * import {RichTextEditor, type RichTextEditorRef} from '@pharos-ds/lab';
 *
