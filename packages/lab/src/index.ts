...
/**
 * @pharos-ds/lab — Experimental Pharos components
 *
 ...
 * Once vetted, components graduate to @pharos-ds/core.
 *
 * This package is published to npm ONLY under the @canary dist-tag
 * (npm install @pharos-ds/lab@canary). It is never released as a
...
export {
  ...
  type SyntaxToken,
} from '@pharos-ds/core/CodeBlock';

// InfoTip — accessible info-icon help affordance (RFC facebook/pharos#3349)
...
// Chart v2 (config model) moved to its own package: @pharos-ds/charts.
// It is no longer re-exported from @pharos-ds/lab.
export * from './Stepper';
...
// RichTextEditor — experimental Lexical WYSIWYG editor (RFC facebook/pharos#3899)
