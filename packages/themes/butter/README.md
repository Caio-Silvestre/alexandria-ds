...
Golden buttery theme for Pharos with blue accents. Sarina for display type, Outfit for headings and body.

## Install

```bash
npm install @pharos-ds/theme-butter
```

## Usage

```tsx
import {butterTheme} from '@pharos-ds/theme-butter/built';
import {XDSTheme} from '@pharos-ds/core/theme';
import '@pharos-ds/theme-butter/theme.css';
