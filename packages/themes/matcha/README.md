...
```bash
npm install @pharos-ds/theme-matcha
```
...
| Path                          | Use case                                               |
| ----------------------------- | ------------------------------------------------------ |
| `@pharos-ds/theme-matcha`           | Source build (StyleX compilation via `@pharos-ds/build`)     |
| `@pharos-ds/theme-matcha/built`     | Pre-built dist (Tailwind, plain CSS, or no build step) |
| `@pharos-ds/theme-matcha/theme.css` | Pre-built CSS file (import in your stylesheet)         |
...
```css
@import '@pharos-ds/theme-matcha/theme.css';
```
