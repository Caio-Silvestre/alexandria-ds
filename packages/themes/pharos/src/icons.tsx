 ...
 * @output Exports pharosIconRegistry for the Pharos theme
 * @position Icon configuration for the Pharos theme; consumed by source.ts
 *
 * Maps semantic icon names to Lucide icon components.
 * These icons are bundled with the theme, not with @pharos-ds/core.
 */

import React from 'react';
import type {IconRegistry} from '@pharos-ds/core/Icon';
...
export const pharosIconRegistry: IconRegistry = {
  close: <X {...iconProps} />,
