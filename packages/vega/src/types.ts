...
/**
 * @file types.ts
 * @input Vega and Vega-Lite spec types, and the Pharos Vega wrapper API surface
 * @output Shared TypeScript types for @pharos-ds/vega
 ...
 *
 * Note: unlike other Pharos components, this component does not accept `xstyle`
 * because `@pharos-ds/vega` does not depend on StyleX. Use `className` or `style`
