 ...
 *
 * Output:
 *   packages/core/dist/pharos.umd.js      global: window.Pharos
 *   packages/core/dist/pharos.umd.js.map
 *
 ...
 *   <link rel="stylesheet" href=".../@pharos-ds/core/dist/pharos.css" />
 *   <script crossorigin src="https://unpkg.com/react@19/umd/react.production.min.js"></script>
 *   <script crossorigin src="https://unpkg.com/react-dom@19/umd/react-dom.production.min.js"></script>
 *   <script src=".../@pharos-ds/core/dist/pharos.umd.js"></script>
 *   <script>const { Button } = window.Pharos; ...</script>
 */
...
const OUTFILE = path.resolve(CORE, 'dist/pharos.umd.js');
...
await build({
  ...
  legalComments: 'none',
  banner: {
    js: '/* @pharos-ds/core UMD bundle — requires global React & ReactDOM (see dist/pharos.umd.js header). */',
  },
  plugins: [reactGlobalsPlugin()],
});

console.log('Built dist/pharos.umd.js (global: Pharos)');
