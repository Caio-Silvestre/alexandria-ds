...
import {colorVars, spacingVars, sizeVars, radiusVars} from '@pharos-ds/core';
...
const styles = stylex.create({
  ...
  button: {
    ...
    {
      type: 'prose',
      text: "See `pharos docs styling` for how to apply tokens via xstyle, className, and compound component patterns. See `pharos docs theme` for overriding tokens with defineTheme.",
    },
  ],
});
