...
export default defineConfig({
  ...
  resolve: {
    alias: [
      // Map @pharos-ds/core subpath imports to source for lab package tests.
      // Must use regex to match subpaths like @pharos-ds/core/Dialog, @pharos-ds/core/theme/tokens.stylex
    ...
    projects: [
      ...
      },
      {
        ...
        test: {
          ...
          globals: true,
          environment: 'node',
          // Several CLI suites spawn a fresh `node bin/pharos.mjs` per assertion
          ...
          testTimeout: 30_000,
          hookTimeout: 30_000,
          // Build @pharos-ds/core once before workers fork. The build-theme
